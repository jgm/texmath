...
records = [Record {point = "00021", uchar = '!', latex = "!", unicodemath = "\\exclam", cls = "N", category = "mathpunct", requirements = "", comments = "EXCLAMATION MARK"}
  ...
  , Record {point = "00300", uchar = '\768', latex = "\\grave", unicodemath = "\\grave", cls = "D", category = "mathaccent", requirements = "", comments = "grave accent"}
  , Record {point = "00301", uchar = '\769', latex = "\\acute", unicodemath = "\\acute", cls = "D", category = "mathaccent", requirements = "", comments = "acute accent"}
  , Record {point = "00302", uchar = '\770', latex = "\\hat", unicodemath = "\\hat", cls = "D", category = "mathaccent", requirements = "", comments = "# \\widehat (amssymb), circumflex accent"}
  , Record {point = "00303", uchar = '\771', latex = "\\tilde", unicodemath = "\\tilde", cls = "D", category = "mathaccent", requirements = "", comments = "# \\widetilde (yhmath, fourier), tilde"}
  , Record {point = "00304", uchar = '\772', latex = "\\bar", unicodemath = "\\bar", cls = "D", category = "mathaccent", requirements = "", comments = "macron"}
  , Record {point = "00305", uchar = '\773', latex = "\\overline", unicodemath = "\\overbar", cls = "D", category = "mathaccent", requirements = "", comments = "overbar embellishment"}
  , Record {point = "00306", uchar = '\774', latex = "\\breve", unicodemath = "\\breve", cls = "D", category = "mathaccent", requirements = "", comments = "breve"}
  , Record {point = "00307", uchar = '\775', latex = "\\dot", unicodemath = "\\dot", cls = "D", category = "mathaccent", requirements = "-oz", comments = "= \\Dot (wrisym), dot above"}
  , Record {point = "00308", uchar = '\776', latex = "\\ddot", unicodemath = "\\ddot", cls = "D", category = "mathaccent", requirements = "", comments = "= \\DDot (wrisym), dieresis"}
  , Record {point = "00309", uchar = '\777', latex = "", unicodemath = "\\ovhook", cls = "", category = "mathaccent", requirements = "", comments = "COMBINING HOOK ABOVE"}
  , Record {point = "0030A", uchar = '\778', latex = "\\mathring", unicodemath = "\\ocirc", cls = "D", category = "mathaccent", requirements = "amssymb", comments = "= \\ring (yhmath), ring"}
  , Record {point = "0030C", uchar = '\780', latex = "\\check", unicodemath = "\\check", cls = "D", category = "mathaccent", requirements = "", comments = "caron"}
  , Record {point = "00310", uchar = '\784', latex = "", unicodemath = "\\candra", cls = "", category = "mathaccent", requirements = "", comments = "candrabindu (non-spacing)"}
  , Record {point = "00311", uchar = '\785', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING INVERTED BREVE"}
  , Record {point = "00312", uchar = '\786', latex = "", unicodemath = "\\oturnedcomma", cls = "", category = "mathaccent", requirements = "", comments = "COMBINING TURNED COMMA ABOVE"}
  , Record {point = "00315", uchar = '\789', latex = "", unicodemath = "\\ocommatopright", cls = "", category = "mathaccent", requirements = "", comments = "COMBINING COMMA ABOVE RIGHT"}
  , Record {point = "0031A", uchar = '\794', latex = "", unicodemath = "\\droang", cls = "", category = "mathaccent", requirements = "", comments = "left angle above (non-spacing)"}
  , Record {point = "00323", uchar = '\803', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING DOT BELOW"}
  , Record {point = "0032C", uchar = '\812', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING CARON BELOW"}
  , Record {point = "0032D", uchar = '\813', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING CIRCUMFLEX ACCENT BELOW"}
  , Record {point = "0032E", uchar = '\814', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING BREVE BELOW"}
  , Record {point = "0032F", uchar = '\815', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING INVERTED BREVE BELOW"}
  , Record {point = "00330", uchar = '\816', latex = "\\utilde", unicodemath = "\\wideutilde", cls = "D", category = "mathaccent", requirements = "undertilde", comments = "under tilde accent (multiple characters and non-spacing)"}
  , Record {point = "00331", uchar = '\817', latex = "\\underbar", unicodemath = "\\underbar", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING MACRON BELOW"}
  , Record {point = "00332", uchar = '\818', latex = "\\underline", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LOW LINE"}
  , Record {point = "00333", uchar = '\819', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "2lowbar"}
  , Record {point = "00338", uchar = '\824', latex = "\\not", unicodemath = "\\not", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LONG SOLIDUS OVERLAY"}
  , Record {point = "0033A", uchar = '\826', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING INVERTED BRIDGE BELOW"}
  , Record {point = "0033F", uchar = '\831', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING DOUBLE OVERLINE"}
  , Record {point = "00346", uchar = '\838', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING BRIDGE ABOVE"}
  ...
  , Record {point = "020D0", uchar = '\8400', latex = "\\lvec", unicodemath = "\\leftharpoonaccent", cls = "D", category = "mathaccent", requirements = "wrisym", comments = "COMBINING LEFT HARPOON ABOVE"}
  , Record {point = "020D1", uchar = '\8401', latex = "\\vec", unicodemath = "\\rightharpoonaccent", cls = "D", category = "mathaccent", requirements = "wrisym", comments = "COMBINING RIGHT HARPOON ABOVE"}
  , Record {point = "020D2", uchar = '\8402', latex = "", unicodemath = "\\vertoverlay", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LONG VERTICAL LINE OVERLAY"}
  , Record {point = "020D3", uchar = '\8403', latex = "", unicodemath = "", cls = "X", category = "mathaccent", requirements = "", comments = "COMBINING SHORT VERTICAL LINE OVERLAY"}
  , Record {point = "020D4", uchar = '\8404', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ANTICLOCKWISE ARROW ABOVE"}
  , Record {point = "020D6", uchar = '\8406', latex = "\\LVec", unicodemath = "\\overleftarrow", cls = "D", category = "mathaccent", requirements = "wrisym", comments = "# \\overleftarrow, COMBINING LEFT ARROW ABOVE"}
  , Record {point = "020D7", uchar = '\8407', latex = "\\vec", unicodemath = "\\vec", cls = "D", category = "mathaccent", requirements = "-wrisym", comments = "= \\Vec (wrisym), # \\overrightarrow, COMBINING RIGHT ARROW ABOVE"}
  , Record {point = "020D8", uchar = '\8408', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING RING OVERLAY"}
  , Record {point = "020D9", uchar = '\8409', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING CLOCKWISE RING OVERLAY"}
  , Record {point = "020DA", uchar = '\8410', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ANTICLOCKWISE RING OVERLAY"}
  , Record {point = "020DB", uchar = '\8411', latex = "\\dddot", unicodemath = "\\dddot", cls = "D", category = "mathaccent", requirements = "amsmath", comments = "= \\DDDot (wrisym), COMBINING THREE DOTS ABOVE"}
  , Record {point = "020DC", uchar = '\8412', latex = "\\ddddot", unicodemath = "\\ddddot", cls = "D", category = "mathaccent", requirements = "amsmath", comments = "COMBINING FOUR DOTS ABOVE"}
  , Record {point = "020DD", uchar = '\8413', latex = "", unicodemath = "\\enclosecircle", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ENCLOSING CIRCLE"}
  , Record {point = "020DE", uchar = '\8414', latex = "", unicodemath = "\\enclosesquare", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ENCLOSING SQUARE"}
  , Record {point = "020DF", uchar = '\8415', latex = "", unicodemath = "\\enclosediamond", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ENCLOSING DIAMOND"}
  , Record {point = "020E1", uchar = '\8417', latex = "\\overleftrightarrow", unicodemath = "\\overleftrightarrow", cls = "D", category = "mathaccent", requirements = "amsmath", comments = "COMBINING LEFT RIGHT ARROW ABOVE"}
  , Record {point = "020E4", uchar = '\8420', latex = "", unicodemath = "\\enclosetriangle", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ENCLOSING UPWARD POINTING TRIANGLE"}
  , Record {point = "020E5", uchar = '\8421', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING REVERSE SOLIDUS OVERLAY"}
  , Record {point = "020E6", uchar = '\8422', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING DOUBLE VERTICAL STROKE OVERLAY, z notation finite function diacritic"}
  , Record {point = "020E7", uchar = '\8423', latex = "", unicodemath = "\\annuity", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING ANNUITY SYMBOL"}
  , Record {point = "020E8", uchar = '\8424', latex = "", unicodemath = "\\threeunderdot", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING TRIPLE UNDERDOT"}
  , Record {point = "020E9", uchar = '\8425', latex = "", unicodemath = "\\widebridgeabove", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING WIDE BRIDGE ABOVE"}
  , Record {point = "020EA", uchar = '\8426', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LEFTWARDS ARROW OVERLAY"}
  , Record {point = "020EB", uchar = '\8427', latex = "", unicodemath = "", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LONG DOUBLE SOLIDUS OVERLAY"}
  , Record {point = "020EC", uchar = '\8428', latex = "", unicodemath = "\\underrightharpoondown", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING RIGHTWARDS HARPOON WITH BARB DOWNWARDS"}
  , Record {point = "020ED", uchar = '\8429', latex = "", unicodemath = "\\underleftharpoondown", cls = "D", category = "mathaccent", requirements = "", comments = "COMBINING LEFTWARDS HARPOON WITH BARB DOWNWARDS"}
  , Record {point = "020EE", uchar = '\8430', latex = "\\underleftarrow", unicodemath = "\\underleftarrow", cls = "D", category = "mathaccent", requirements = "amsmath", comments = "COMBINING LEFT ARROW BELOW"}
  , Record {point = "020EF", uchar = '\8431', latex = "\\underrightarrow", unicodemath = "\\underrightarrow", cls = "D", category = "mathaccent", requirements = "amsmath", comments = "COMBINING RIGHT ARROW BELOW"}
  , Record {point = "020F0", uchar = '\8432', latex = "", unicodemath = "\\asteraccent", cls = "", category = "mathaccent", requirements = "", comments = "COMBINING ASTERISK ABOVE"}
