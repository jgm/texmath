...
This module is derived from the list at
<https://typst.app/docs/reference/symbols/sym/>

-}

module Text.TeXMath.Unicode.ToTypst
  ( toTypstSymbol
  , fromTypstSymbol
  , typstSymbols
  ) where
...
toTypstSymbol :: Char -> Maybe Text
toTypstSymbol c = M.lookup c typstToSymbolMap

fromTypstSymbol :: Text -> Maybe Char
fromTypstSymbol t = M.lookup t typstFromSymbolMap

typstToSymbolMap :: M.Map Char Text
typstToSymbolMap = M.fromList typstSymbols

typstFromSymbolMap :: M.Map Text Char
typstFromSymbolMap = foldr (uncurry (flip M.insert)) mempty typstSymbols

typstSymbols :: [(Char, Text)]
typstSymbols =
  [ ('\x1d538',"AA")
  , ('\x391',"Alpha")
  , ('\x1d539',"BB")
