...
records =
  ...
  , Record {uchar = '\9184', commands = [("base",""),("unicode-math","\\obrbrak")], category = Ord, comments = "TOP TORTOISE SHELL BRACKET (mathematical use)"}
  , Record {uchar = '\9185', commands = [("base",""),("unicode-math","\\ubrbrak")], category = Ord, comments = "BOTTOM TORTOISE SHELL BRACKET (mathematical use)"}
  , Record {uchar = '\9186', commands = [("base",""),("unicode-math","\\trapezium")], category = Ord, comments = "WHITE TRAPEZIUM"}
  , Record {uchar = '\9187', commands = [("base",""),("unicode-math","\\benzenr")], category = Ord, comments = "BENZENE RING WITH CIRCLE"}
  , Record {uchar = '\9188', commands = [("base",""),("unicode-math","\\strns")], category = Ord, comments = "STRAIGHTNESS"}
  , Record {uchar = '\9189', commands = [("base",""),("unicode-math","\\fltns")], category = Ord, comments = "FLATNESS"}
  , Record {uchar = '\9190', commands = [("base",""),("wasysym","\\AC"),("unicode-math","\\accurrent")], category = Ord, comments = "AC CURRENT"}
  , Record {uchar = '\9191', commands = [("base",""),("unicode-math","\\elinters")], category = Ord, comments = "ELECTRICAL INTERSECTION"}
  , Record {uchar = '\9416', commands = [("base",""),("unicode-math","")], category = Ord, comments = "oS capital S in circle"}
  , Record {uchar = '\9478', commands = [("base",""),("unicode-math","\\bdtriplevdash")], category = Ord, comments = "doubly broken vert"}
  , Record {uchar = '\9600', commands = [("base",""),("unicode-math","\\blockuphalf")], category = Ord, comments = "UPPER HALF BLOCK"}
  , Record {uchar = '\9604', commands = [("base",""),("unicode-math","\\blocklowhalf")], category = Ord, comments = "LOWER HALF BLOCK"}
  , Record {uchar = '\9608', commands = [("base",""),("unicode-math","\\blockfull")], category = Ord, comments = "FULL BLOCK"}
  , Record {uchar = '\9612', commands = [("base",""),("unicode-math","\\blocklefthalf")], category = Ord, comments = "LEFT HALF BLOCK"}
  , Record {uchar = '\9616', commands = [("base",""),("unicode-math","\\blockrighthalf")], category = Ord, comments = "RIGHT HALF BLOCK"}
  , Record {uchar = '\9617', commands = [("base",""),("unicode-math","\\blockqtrshaded")], category = Ord, comments = "25\\% shaded block"}
  , Record {uchar = '\9618', commands = [("base",""),("unicode-math","\\blockhalfshaded")], category = Ord, comments = "50\\% shaded block"}
  , Record {uchar = '\9619', commands = [("base",""),("unicode-math","\\blockthreeqtrshaded")], category = Ord, comments = "75\\% shaded block"}
  ...
  , Record {uchar = '\9634', commands = [("base",""),("unicode-math","\\squoval")], category = Ord, comments = "WHITE SQUARE WITH ROUNDED CORNERS"}
  , Record {uchar = '\9635', commands = [("base",""),("unicode-math","\\blackinwhitesquare")], category = Ord, comments = "WHITE SQUARE CONTAINING BLACK SMALL SQUARE"}
  , Record {uchar = '\9636', commands = [("base",""),("unicode-math","\\squarehfill")], category = Ord, comments = "square, horizontal rule filled"}
  , Record {uchar = '\9637', commands = [("base",""),("unicode-math","\\squarevfill")], category = Ord, comments = "square, vertical rule filled"}
  , Record {uchar = '\9638', commands = [("base",""),("unicode-math","\\squarehvfill")], category = Ord, comments = "SQUARE WITH ORTHOGONAL CROSSHATCH FILL"}
  , Record {uchar = '\9639', commands = [("base",""),("unicode-math","\\squarenwsefill")], category = Ord, comments = "square, nw-to-se rule filled"}
  , Record {uchar = '\9640', commands = [("base",""),("unicode-math","\\squareneswfill")], category = Ord, comments = "square, ne-to-sw rule filled"}
  , Record {uchar = '\9641', commands = [("base",""),("unicode-math","\\squarecrossfill")], category = Ord, comments = "SQUARE WITH DIAGONAL CROSSHATCH FILL"}
  , Record {uchar = '\9642', commands = [("base",""),("unicode-math","\\smblksquare")], category = Ord, comments = "sq bullet, filled"}
  , Record {uchar = '\9643', commands = [("base",""),("unicode-math","\\smwhtsquare")], category = Ord, comments = "WHITE SMALL SQUARE"}
  , Record {uchar = '\9644', commands = [("base",""),("unicode-math","\\hrectangleblack")], category = Ord, comments = "BLACK RECTANGLE"}
  , Record {uchar = '\9645', commands = [("base",""),("unicode-math","\\hrectangle")], category = Ord, comments = "horizontal rectangle, open"}
  , Record {uchar = '\9646', commands = [("base",""),("unicode-math","\\vrectangleblack")], category = Ord, comments = "BLACK VERTICAL RECTANGLE"}
  , Record {uchar = '\9647', commands = [("base",""),("unicode-math","\\vrectangle")], category = Ord, comments = "rectangle, white (vertical)"}
  , Record {uchar = '\9648', commands = [("base",""),("unicode-math","\\parallelogramblack")], category = Ord, comments = "BLACK PARALLELOGRAM"}
  , Record {uchar = '\9649', commands = [("base",""),("unicode-math","\\parallelogram")], category = Ord, comments = "parallelogram, open"}
  , Record {uchar = '\9650', commands = [("base",""),("unicode-math","\\bigblacktriangleup")], category = Ord, comments = "BLACK UP-POINTING TRIANGLE"}
  ...
  , Record {uchar = '\9658', commands = [("base",""),("unicode-math","\\blackpointerright")], category = Ord, comments = "BLACK RIGHT-POINTING POINTER"}
  , Record {uchar = '\9659', commands = [("base",""),("mathabx","\\triangleright"),("unicode-math","\\whitepointerright")], category = Ord, comments = "WHITE RIGHT-POINTING POINTER"}
  , Record {uchar = '\9660', commands = [("base",""),("unicode-math","\\bigblacktriangledown")], category = Ord, comments = "big down triangle, filled"}
  ...
  , Record {uchar = '\9668', commands = [("base",""),("unicode-math","\\blackpointerleft")], category = Ord, comments = "BLACK LEFT-POINTING POINTER"}
  , Record {uchar = '\9669', commands = [("base",""),("mathabx","\\triangleleft"),("unicode-math","\\whitepointerleft")], category = Ord, comments = "WHITE LEFT-POINTING POINTER"}
  ...
  , Record {uchar = '\9672', commands = [("base",""),("unicode-math","\\blackinwhitediamond")], category = Ord, comments = "WHITE DIAMOND CONTAINING BLACK SMALL DIAMOND"}
  , Record {uchar = '\9673', commands = [("base",""),("unicode-math","\\fisheye")], category = Ord, comments = "FISHEYE"}
  ...
  , Record {uchar = '\9676', commands = [("base",""),("unicode-math","\\dottedcircle")], category = Ord, comments = "DOTTED CIRCLE"}
  , Record {uchar = '\9677', commands = [("base",""),("unicode-math","\\circlevertfill")], category = Ord, comments = "CIRCLE WITH VERTICAL FILL"}
  , Record {uchar = '\9678', commands = [("base",""),("amssymb","\\circledcirc"),("unicode-math","\\bullseye")], category = Ord, comments = "BULLSEYE"}
  ...
  , Record {uchar = '\9682', commands = [("base",""),("unicode-math","\\circlebottomhalfblack")], category = Ord, comments = "circle, filled bottom half"}
  , Record {uchar = '\9683', commands = [("base",""),("unicode-math","\\circletophalfblack")], category = Ord, comments = "circle, filled top half"}
  , Record {uchar = '\9684', commands = [("base",""),("unicode-math","\\circleurquadblack")], category = Ord, comments = "CIRCLE WITH UPPER RIGHT QUADRANT BLACK"}
  , Record {uchar = '\9685', commands = [("base",""),("unicode-math","\\blackcircleulquadwhite")], category = Ord, comments = "CIRCLE WITH ALL BUT UPPER LEFT QUADRANT BLACK"}
  ...
  , Record {uchar = '\9688', commands = [("base",""),("unicode-math","\\inversebullet")], category = Ord, comments = "INVERSE BULLET"}
  , Record {uchar = '\9689', commands = [("base",""),("unicode-math","\\inversewhitecircle")], category = Ord, comments = "INVERSE WHITE CIRCLE"}
  , Record {uchar = '\9690', commands = [("base",""),("unicode-math","\\invwhiteupperhalfcircle")], category = Ord, comments = "UPPER HALF INVERSE WHITE CIRCLE"}
  , Record {uchar = '\9691', commands = [("base",""),("unicode-math","\\invwhitelowerhalfcircle")], category = Ord, comments = "LOWER HALF INVERSE WHITE CIRCLE"}
  , Record {uchar = '\9692', commands = [("base",""),("unicode-math","\\ularc")], category = Ord, comments = "UPPER LEFT QUADRANT CIRCULAR ARC"}
  , Record {uchar = '\9693', commands = [("base",""),("unicode-math","\\urarc")], category = Ord, comments = "UPPER RIGHT QUADRANT CIRCULAR ARC"}
  , Record {uchar = '\9694', commands = [("base",""),("unicode-math","\\lrarc")], category = Ord, comments = "LOWER RIGHT QUADRANT CIRCULAR ARC"}
  , Record {uchar = '\9695', commands = [("base",""),("unicode-math","\\llarc")], category = Ord, comments = "LOWER LEFT QUADRANT CIRCULAR ARC"}
  , Record {uchar = '\9696', commands = [("base",""),("unicode-math","\\topsemicircle")], category = Ord, comments = "UPPER HALF CIRCLE"}
  , Record {uchar = '\9697', commands = [("base",""),("unicode-math","\\botsemicircle")], category = Ord, comments = "LOWER HALF CIRCLE"}
  , Record {uchar = '\9698', commands = [("base",""),("unicode-math","\\lrblacktriangle")], category = Ord, comments = "lower right triangle, filled"}
  , Record {uchar = '\9699', commands = [("base",""),("unicode-math","\\llblacktriangle")], category = Ord, comments = "lower left triangle, filled"}
  , Record {uchar = '\9700', commands = [("base",""),("unicode-math","\\ulblacktriangle")], category = Ord, comments = "upper left triangle, filled"}
  , Record {uchar = '\9701', commands = [("base",""),("unicode-math","\\urblacktriangle")], category = Ord, comments = "upper right triangle, filled"}
  , Record {uchar = '\9702', commands = [("base",""),("unicode-math","\\smwhtcircle")], category = Ord, comments = "WHITE BULLET"}
  , Record {uchar = '\9703', commands = [("base",""),("unicode-math","\\squareleftblack")], category = Ord, comments = "square, filled left half"}
  , Record {uchar = '\9704', commands = [("base",""),("unicode-math","\\squarerightblack")], category = Ord, comments = "square, filled right half"}
  , Record {uchar = '\9705', commands = [("base",""),("unicode-math","\\squareulblack")], category = Ord, comments = "square, filled top left corner"}
  , Record {uchar = '\9706', commands = [("base",""),("unicode-math","\\squarelrblack")], category = Ord, comments = "square, filled bottom right corner"}
  , Record {uchar = '\9707', commands = [("stmaryrd","\\boxbar"),("txfonts","\\boxbar"),("unicode-math","\\boxbar")], category = Bin, comments = "vertical bar in box"}
  , Record {uchar = '\9708', commands = [("base",""),("unicode-math","\\trianglecdot")], category = Ord, comments = "triangle with centered dot"}
  , Record {uchar = '\9709', commands = [("base",""),("unicode-math","\\triangleleftblack")], category = Ord, comments = "UP-POINTING TRIANGLE WITH LEFT HALF BLACK"}
  , Record {uchar = '\9710', commands = [("base",""),("unicode-math","\\trianglerightblack")], category = Ord, comments = "UP-POINTING TRIANGLE WITH RIGHT HALF BLACK"}
  , Record {uchar = '\9711', commands = [("base",""),("unicode-math","\\lgwhtcircle")], category = Ord, comments = "LARGE CIRCLE"}
  , Record {uchar = '\9712', commands = [("base",""),("unicode-math","\\squareulquad")], category = Ord, comments = "WHITE SQUARE WITH UPPER LEFT QUADRANT"}
  , Record {uchar = '\9713', commands = [("base",""),("unicode-math","\\squarellquad")], category = Ord, comments = "WHITE SQUARE WITH LOWER LEFT QUADRANT"}
  , Record {uchar = '\9714', commands = [("base",""),("unicode-math","\\squarelrquad")], category = Ord, comments = "WHITE SQUARE WITH LOWER RIGHT QUADRANT"}
  , Record {uchar = '\9715', commands = [("base",""),("unicode-math","\\squareurquad")], category = Ord, comments = "WHITE SQUARE WITH UPPER RIGHT QUADRANT"}
  , Record {uchar = '\9716', commands = [("base",""),("unicode-math","\\circleulquad")], category = Ord, comments = "WHITE CIRCLE WITH UPPER LEFT QUADRANT"}
  , Record {uchar = '\9717', commands = [("base",""),("unicode-math","\\circlellquad")], category = Ord, comments = "WHITE CIRCLE WITH LOWER LEFT QUADRANT"}
  , Record {uchar = '\9718', commands = [("base",""),("unicode-math","\\circlelrquad")], category = Ord, comments = "WHITE CIRCLE WITH LOWER RIGHT QUADRANT"}
  , Record {uchar = '\9719', commands = [("base",""),("unicode-math","\\circleurquad")], category = Ord, comments = "WHITE CIRCLE WITH UPPER RIGHT QUADRANT"}
  , Record {uchar = '\9720', commands = [("base",""),("unicode-math","\\ultriangle")], category = Ord, comments = "UPPER LEFT TRIANGLE"}
  , Record {uchar = '\9721', commands = [("base",""),("unicode-math","\\urtriangle")], category = Ord, comments = "UPPER RIGHT TRIANGLE"}
  , Record {uchar = '\9722', commands = [("base",""),("unicode-math","\\lltriangle")], category = Ord, comments = "LOWER LEFT TRIANGLE"}
  ...
  , Record {uchar = '\9725', commands = [("base",""),("unicode-math","\\mdsmwhtsquare")], category = Ord, comments = "WHITE MEDIUM SMALL SQUARE"}
  , Record {uchar = '\9726', commands = [("base",""),("unicode-math","\\mdsmblksquare")], category = Ord, comments = "BLACK MEDIUM SMALL SQUARE"}
  , Record {uchar = '\9727', commands = [("base",""),("unicode-math","\\lrtriangle")], category = Ord, comments = "LOWER RIGHT TRIANGLE"}
  , Record {uchar = '\9733', commands = [("amssymb","\\bigstar"),("unicode-math","\\bigstar")], category = Ord, comments = "star, filled"}
  , Record {uchar = '\9734', commands = [("base",""),("unicode-math","\\bigwhitestar")], category = Ord, comments = "star, open"}
  , Record {uchar = '\9737', commands = [("mathabx","\\Sun"),("unicode-math","\\astrosun")], category = Ord, comments = "SUN"}
  , Record {uchar = '\9740', commands = [("wasysym",""),("unicode-math","")], category = Ord, comments = "text \\CONJUNCTION (wasysym), CONJUNCTION"}
  , Record {uchar = '\9744', commands = [("wasysym","\\Square"),("unicode-math","")], category = Ord, comments = "BALLOT BOX"}
  , Record {uchar = '\9745', commands = [("wasysym","\\CheckedBox"),("unicode-math","")], category = Ord, comments = "t \\Checkedbox (marvosym), BALLOT BOX WITH CHECK"}
  , Record {uchar = '\9746', commands = [("wasysym","\\XBox"),("unicode-math","")], category = Ord, comments = "t \\Crossedbox (marvosym), BALLOT BOX WITH X"}
  , Record {uchar = '\9749', commands = [("arevmath","\\steaming"),("unicode-math","")], category = Ord, comments = "HOT BEVERAGE"}
  , Record {uchar = '\9758', commands = [("arevmath","\\pointright"),("unicode-math","")], category = Ord, comments = "WHITE RIGHT POINTING INDEX"}
  , Record {uchar = '\9760', commands = [("arevmath","\\skull"),("unicode-math","")], category = Ord, comments = "SKULL AND CROSSBONES"}
  , Record {uchar = '\9761', commands = [("base",""),("unicode-math","\\danger")], category = Ord, comments = "CAUTION SIGN, dangerous bend"}
  , Record {uchar = '\9762', commands = [("arevmath","\\radiation"),("unicode-math","")], category = Ord, comments = "RADIOACTIVE SIGN"}
  , Record {uchar = '\9763', commands = [("arevmath","\\biohazard"),("unicode-math","")], category = Ord, comments = "BIOHAZARD SIGN"}
  , Record {uchar = '\9775', commands = [("arevmath","\\yinyang"),("unicode-math","")], category = Ord, comments = "YIN YANG"}
  , Record {uchar = '\9785', commands = [("wasysym","\\frownie"),("arevmath","\\sadface"),("unicode-math","")], category = Ord, comments = "WHITE FROWNING FACE"}
  , Record {uchar = '\9786', commands = [("wasysym","\\smiley"),("arevmath","\\smileface"),("unicode-math","")], category = Ord, comments = "WHITE SMILING FACE"}
  ...
  , Record {uchar = '\9791', commands = [("wasysym","\\mercury"),("mathabx","\\Mercury"),("unicode-math","")], category = Ord, comments = "MERCURY"}
  ...
  , Record {uchar = '\9793', commands = [("wasysym","\\earth"),("mathabx","\\varEarth"),("unicode-math","")], category = Ord, comments = "EARTH"}
  , Record {uchar = '\9794', commands = [("wasysym","\\male"),("mathabx","\\Mars"),("unicode-math","\\male")], category = Ord, comments = "= \\boy (mathabx), mars, male"}
  , Record {uchar = '\9795', commands = [("wasysym","\\jupiter"),("mathabx","\\Jupiter"),("unicode-math","")], category = Ord, comments = "JUPITER"}
  , Record {uchar = '\9796', commands = [("wasysym","\\saturn"),("mathabx","\\Saturn"),("unicode-math","")], category = Ord, comments = "SATURN"}
  , Record {uchar = '\9797', commands = [("wasysym","\\uranus"),("mathabx","\\Uranus"),("unicode-math","")], category = Ord, comments = "URANUS"}
  , Record {uchar = '\9798', commands = [("wasysym","\\neptune"),("mathabx","\\Neptune"),("unicode-math","")], category = Ord, comments = "NEPTUNE"}
  , Record {uchar = '\9799', commands = [("wasysym","\\pluto"),("mathabx","\\Pluto"),("unicode-math","")], category = Ord, comments = "PLUTO"}
  , Record {uchar = '\9800', commands = [("wasysym","\\aries"),("mathabx","\\Aries"),("unicode-math","")], category = Ord, comments = "ARIES"}
  , Record {uchar = '\9801', commands = [("wasysym","\\taurus"),("mathabx","\\Taurus"),("unicode-math","")], category = Ord, comments = "TAURUS"}
  , Record {uchar = '\9802', commands = [("wasysym","\\gemini"),("mathabx","\\Gemini"),("unicode-math","")], category = Ord, comments = "GEMINI"}
  , Record {uchar = '\9803', commands = [("wasysym","\\cancer"),("unicode-math","")], category = Ord, comments = "CANCER"}
  , Record {uchar = '\9804', commands = [("wasysym","\\leo"),("mathabx","\\Leo"),("unicode-math","")], category = Ord, comments = "LEO"}
  , Record {uchar = '\9805', commands = [("wasysym","\\virgo"),("unicode-math","")], category = Ord, comments = "VIRGO"}
  , Record {uchar = '\9806', commands = [("wasysym","\\libra"),("mathabx","\\Libra"),("unicode-math","")], category = Ord, comments = "LIBRA"}
  , Record {uchar = '\9807', commands = [("wasysym","\\scorpio"),("mathabx","\\Scorpio"),("unicode-math","")], category = Ord, comments = "SCORPIUS"}
  , Record {uchar = '\9808', commands = [("wasysym","\\sagittarius"),("unicode-math","")], category = Ord, comments = "SAGITTARIUS"}
  , Record {uchar = '\9809', commands = [("wasysym","\\capricornus"),("unicode-math","")], category = Ord, comments = "CAPRICORN"}
  , Record {uchar = '\9810', commands = [("wasysym","\\aquarius"),("unicode-math","")], category = Ord, comments = "AQUARIUS"}
  , Record {uchar = '\9811', commands = [("wasysym","\\pisces"),("unicode-math","")], category = Ord, comments = "PISCES"}
  ...
  , Record {uchar = '\9836', commands = [("arevmath","\\sixteenthnote"),("unicode-math","")], category = Ord, comments = "BEAMED SIXTEENTH NOTES"}
  ...
  , Record {uchar = '\9851', commands = [("arevmath","\\recycle"),("unicode-math","")], category = Ord, comments = "BLACK UNIVERSAL RECYCLING SYMBOL"}
  , Record {uchar = '\9854', commands = [("base",""),("unicode-math","\\acidfree")], category = Ord, comments = "PERMANENT PAPER SIGN"}
  , Record {uchar = '\9856', commands = [("base",""),("unicode-math","\\dicei")], category = Ord, comments = "DIE FACE-1"}
  , Record {uchar = '\9857', commands = [("base",""),("unicode-math","\\diceii")], category = Ord, comments = "DIE FACE-2"}
  , Record {uchar = '\9858', commands = [("base",""),("unicode-math","\\diceiii")], category = Ord, comments = "DIE FACE-3"}
  , Record {uchar = '\9859', commands = [("base",""),("unicode-math","\\diceiv")], category = Ord, comments = "DIE FACE-4"}
  , Record {uchar = '\9860', commands = [("base",""),("unicode-math","\\dicev")], category = Ord, comments = "DIE FACE-5"}
  , Record {uchar = '\9861', commands = [("base",""),("unicode-math","\\dicevi")], category = Ord, comments = "DIE FACE-6"}
  , Record {uchar = '\9862', commands = [("base",""),("unicode-math","\\circledrightdot")], category = Ord, comments = "WHITE CIRCLE WITH DOT RIGHT"}
  , Record {uchar = '\9863', commands = [("base",""),("unicode-math","\\circledtwodots")], category = Ord, comments = "WHITE CIRCLE WITH TWO DOTS"}
  , Record {uchar = '\9864', commands = [("base",""),("unicode-math","\\blackcircledrightdot")], category = Ord, comments = "BLACK CIRCLE WITH WHITE DOT RIGHT"}
  , Record {uchar = '\9865', commands = [("base",""),("unicode-math","\\blackcircledtwodots")], category = Ord, comments = "BLACK CIRCLE WITH TWO WHITE DOTS"}
  , Record {uchar = '\9875', commands = [("arevmath","\\anchor"),("unicode-math","")], category = Ord, comments = "ANCHOR"}
  , Record {uchar = '\9876', commands = [("arevmath","\\swords"),("unicode-math","")], category = Ord, comments = "CROSSED SWORDS"}
  , Record {uchar = '\9888', commands = [("arevmath","\\warning"),("unicode-math","")], category = Ord, comments = "WARNING SIGN"}
  , Record {uchar = '\9893', commands = [("base",""),("unicode-math","\\Hermaphrodite")], category = Ord, comments = "MALE AND FEMALE SIGN"}
  ...
  , Record {uchar = '\9900', commands = [("base",""),("unicode-math","\\mdsmwhtcircle")], category = Ord, comments = "MEDIUM SMALL WHITE CIRCLE"}
  , Record {uchar = '\9906', commands = [("base",""),("unicode-math","\\neuter")], category = Ord, comments = "NEUTER"}
  , Record {uchar = '\9998', commands = [("arevmath","\\pencil"),("unicode-math","")], category = Ord, comments = "LOWER RIGHT PENCIL"}
  ...
  , Record {uchar = '\10007', commands = [("arevmath","\\ballotx"),("unicode-math","")], category = Ord, comments = "BALLOT X"}
  , Record {uchar = '\10016', commands = [("amsfonts","\\maltese"),("unicode-math","\\maltese")], category = Ord, comments = "MALTESE CROSS"}
  , Record {uchar = '\10026', commands = [("base",""),("unicode-math","\\circledstar")], category = Ord, comments = "CIRCLED WHITE STAR"}
  , Record {uchar = '\10038', commands = [("base",""),("unicode-math","\\varstar")], category = Ord, comments = "SIX POINTED BLACK STAR"}
  , Record {uchar = '\10045', commands = [("base",""),("unicode-math","\\dingasterisk")], category = Ord, comments = "HEAVY TEARDROP-SPOKED ASTERISK"}
  , Record {uchar = '\10098', commands = [("base",""),("unicode-math","\\lbrbrak")], category = Open, comments = "LIGHT LEFT TORTOISE SHELL BRACKET ORNAMENT"}
  , Record {uchar = '\10099', commands = [("base",""),("unicode-math","\\rbrbrak")], category = Close, comments = "LIGHT RIGHT TORTOISE SHELL BRACKET ORNAMENT"}
  , Record {uchar = '\10139', commands = [("base",""),("unicode-math","\\draftingarrow")], category = Ord, comments = "right arrow with bold head (drafting)"}
  , Record {uchar = '\10146', commands = [("arevmath","\\arrowbullet"),("unicode-math","")], category = Ord, comments = "THREE-D TOP-LIGHTED RIGHTWARDS ARROWHEAD"}
  , Record {uchar = '\10176', commands = [("base",""),("unicode-math","\\threedangle")], category = Ord, comments = "THREE DIMENSIONAL ANGLE"}
  , Record {uchar = '\10177', commands = [("base",""),("unicode-math","\\whiteinwhitetriangle")], category = Ord, comments = "WHITE TRIANGLE CONTAINING SMALL WHITE TRIANGLE"}
  , Record {uchar = '\10178', commands = [("base","\\perp"),("unicode-math","\\perp")], category = Rel, comments = "PERPENDICULAR"}
  , Record {uchar = '\10179', commands = [("base",""),("unicode-math","\\subsetcirc")], category = Ord, comments = "OPEN SUBSET"}
  , Record {uchar = '\10180', commands = [("base",""),("unicode-math","\\supsetcirc")], category = Ord, comments = "OPEN SUPERSET"}
  ...
  , Record {uchar = '\10183', commands = [("base",""),("unicode-math","\\veedot")], category = Bin, comments = "OR WITH DOT INSIDE"}
  , Record {uchar = '\10184', commands = [("base",""),("unicode-math","\\bsolhsub")], category = Rel, comments = "REVERSE SOLIDUS PRECEDING SUBSET"}
  , Record {uchar = '\10185', commands = [("base",""),("unicode-math","\\suphsol")], category = Rel, comments = "SUPERSET PRECEDING SOLIDUS"}
  , Record {uchar = '\10188', commands = [("base",""),("unicode-math","\\longdivision")], category = Open, comments = "LONG DIVISION"}
  ...
  , Record {uchar = '\10193', commands = [("base",""),("unicode-math","\\wedgedot")], category = Bin, comments = "AND WITH DOT"}
  , Record {uchar = '\10194', commands = [("base",""),("unicode-math","\\upin")], category = Rel, comments = "ELEMENT OF OPENING UPWARDS"}
  , Record {uchar = '\10195', commands = [("base",""),("unicode-math","\\pullback")], category = Rel, comments = "LOWER RIGHT CORNER WITH DOT"}
  , Record {uchar = '\10196', commands = [("base",""),("unicode-math","\\pushout")], category = Rel, comments = "UPPER LEFT CORNER WITH DOT"}
  , Record {uchar = '\10197', commands = [("base",""),("unicode-math","\\leftouterjoin")], category = Op, comments = "LEFT OUTER JOIN"}
  , Record {uchar = '\10198', commands = [("base",""),("unicode-math","\\rightouterjoin")], category = Op, comments = "RIGHT OUTER JOIN"}
  , Record {uchar = '\10199', commands = [("base",""),("unicode-math","\\fullouterjoin")], category = Op, comments = "FULL OUTER JOIN"}
  , Record {uchar = '\10200', commands = [("base",""),("unicode-math","\\bigbot")], category = Op, comments = "LARGE UP TACK"}
  , Record {uchar = '\10201', commands = [("base",""),("unicode-math","\\bigtop")], category = Op, comments = "LARGE DOWN TACK"}
  , Record {uchar = '\10202', commands = [("base",""),("unicode-math","\\DashVDash")], category = Rel, comments = "LEFT AND RIGHT DOUBLE TURNSTILE"}
  , Record {uchar = '\10203', commands = [("base",""),("unicode-math","\\dashVdash")], category = Rel, comments = "LEFT AND RIGHT TACK"}
  , Record {uchar = '\10204', commands = [("txfonts","\\multimapinv"),("unicode-math","\\multimapinv")], category = Rel, comments = "LEFT MULTIMAP"}
  , Record {uchar = '\10205', commands = [("base",""),("unicode-math","\\vlongdash")], category = Rel, comments = "long left tack"}
  , Record {uchar = '\10206', commands = [("base",""),("unicode-math","\\longdashv")], category = Rel, comments = "long right tack"}
  , Record {uchar = '\10207', commands = [("base",""),("unicode-math","\\cirbot")], category = Rel, comments = "UP TACK WITH CIRCLE ABOVE"}
  , Record {uchar = '\10208', commands = [("base",""),("unicode-math","\\lozengeminus")], category = Bin, comments = "LOZENGE DIVIDED BY HORIZONTAL RULE"}
  , Record {uchar = '\10209', commands = [("base",""),("unicode-math","\\concavediamond")], category = Bin, comments = "WHITE CONCAVE-SIDED DIAMOND"}
  , Record {uchar = '\10210', commands = [("base",""),("unicode-math","\\concavediamondtickleft")], category = Bin, comments = "WHITE CONCAVE-SIDED DIAMOND WITH LEFTWARDS TICK"}
  , Record {uchar = '\10211', commands = [("base",""),("unicode-math","\\concavediamondtickright")], category = Bin, comments = "WHITE CONCAVE-SIDED DIAMOND WITH RIGHTWARDS TICK"}
  , Record {uchar = '\10212', commands = [("base",""),("unicode-math","\\whitesquaretickleft")], category = Bin, comments = "WHITE SQUARE WITH LEFTWARDS TICK"}
  , Record {uchar = '\10213', commands = [("base",""),("unicode-math","\\whitesquaretickright")], category = Bin, comments = "WHITE SQUARE WITH RIGHTWARDS TICK"}
  ...
  , Record {uchar = '\10220', commands = [("base",""),("unicode-math","\\Lbrbrak")], category = Open, comments = "MATHEMATICAL LEFT WHITE TORTOISE SHELL BRACKET"}
  , Record {uchar = '\10221', commands = [("base",""),("unicode-math","\\Rbrbrak")], category = Close, comments = "MATHEMATICAL RIGHT WHITE TORTOISE SHELL BRACKET"}
  , Record {uchar = '\10222', commands = [("base","\\lgroup"),("unicode-math","")], category = Open, comments = "MATHEMATICAL LEFT FLATTENED PARENTHESIS"}
  , Record {uchar = '\10223', commands = [("base","\\rgroup"),("unicode-math","")], category = Close, comments = "MATHEMATICAL RIGHT FLATTENED PARENTHESIS"}
  , Record {uchar = '\10224', commands = [("base",""),("unicode-math","\\UUparrow")], category = Rel, comments = "UPWARDS QUADRUPLE ARROW"}
  , Record {uchar = '\10225', commands = [("base",""),("unicode-math","\\DDownarrow")], category = Rel, comments = "DOWNWARDS QUADRUPLE ARROW"}
  , Record {uchar = '\10226', commands = [("base",""),("unicode-math","\\acwgapcirclearrow")], category = Rel, comments = "ANTICLOCKWISE GAPPED CIRCLE ARROW"}
  , Record {uchar = '\10227', commands = [("base",""),("unicode-math","\\cwgapcirclearrow")], category = Rel, comments = "CLOCKWISE GAPPED CIRCLE ARROW"}
  , Record {uchar = '\10228', commands = [("base",""),("unicode-math","\\rightarrowonoplus")], category = Rel, comments = "RIGHT ARROW WITH CIRCLED PLUS"}
  ...
  , Record {uchar = '\10239', commands = [("base",""),("unicode-math","\\longrightsquigarrow")], category = Rel, comments = "LONG RIGHTWARDS SQUIGGLE ARROW"}
  ...
  , Record {uchar = '\10504', commands = [("base",""),("unicode-math","\\downarrowbarred")], category = Rel, comments = "DOWNWARDS ARROW WITH HORIZONTAL STROKE"}
  , Record {uchar = '\10505', commands = [("base",""),("unicode-math","\\uparrowbarred")], category = Rel, comments = "UPWARDS ARROW WITH HORIZONTAL STROKE"}
  , Record {uchar = '\10506', commands = [("base",""),("unicode-math","\\Uuparrow")], category = Rel, comments = "UPWARDS TRIPLE ARROW"}
  , Record {uchar = '\10507', commands = [("base",""),("unicode-math","\\Ddownarrow")], category = Rel, comments = "DOWNWARDS TRIPLE ARROW"}
  , Record {uchar = '\10508', commands = [("base",""),("unicode-math","\\leftbkarrow")], category = Rel, comments = "LEFTWARDS DOUBLE DASH ARROW"}
  , Record {uchar = '\10509', commands = [("base",""),("unicode-math","\\rightbkarrow")], category = Rel, comments = "RIGHTWARDS DOUBLE DASH ARROW"}
  , Record {uchar = '\10510', commands = [("base",""),("unicode-math","\\leftdbkarrow")], category = Rel, comments = "LEFTWARDS TRIPLE DASH ARROW"}
  , Record {uchar = '\10511', commands = [("base",""),("unicode-math","\\dbkarow")], category = Rel, comments = "RIGHTWARDS TRIPLE DASH ARROW"}
  , Record {uchar = '\10512', commands = [("base",""),("unicode-math","\\drbkarow")], category = Rel, comments = "RIGHTWARDS TWO-HEADED TRIPLE DASH ARROW"}
  , Record {uchar = '\10513', commands = [("base",""),("unicode-math","\\rightdotarrow")], category = Rel, comments = "RIGHTWARDS ARROW WITH DOTTED STEM"}
  ...
  , Record {uchar = '\10519', commands = [("base",""),("unicode-math","\\nvtwoheadrightarrowtail")], category = Rel, comments = "RIGHTWARDS TWO-HEADED ARROW WITH TAIL WITH VERTICAL STROKE, z notation surjective injection"}
  , Record {uchar = '\10520', commands = [("base",""),("unicode-math","\\nVtwoheadrightarrowtail")], category = Rel, comments = "RIGHTWARDS TWO-HEADED ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE, z notation finite surjective injection"}
  , Record {uchar = '\10521', commands = [("base",""),("unicode-math","\\lefttail")], category = Rel, comments = "LEFTWARDS ARROW-TAIL"}
  , Record {uchar = '\10522', commands = [("base",""),("unicode-math","\\righttail")], category = Rel, comments = "RIGHTWARDS ARROW-TAIL"}
  , Record {uchar = '\10523', commands = [("base",""),("unicode-math","\\leftdbltail")], category = Rel, comments = "LEFTWARDS DOUBLE ARROW-TAIL"}
  , Record {uchar = '\10524', commands = [("base",""),("unicode-math","\\rightdbltail")], category = Rel, comments = "RIGHTWARDS DOUBLE ARROW-TAIL"}
  , Record {uchar = '\10525', commands = [("base",""),("unicode-math","\\diamondleftarrow")], category = Rel, comments = "LEFTWARDS ARROW TO BLACK DIAMOND"}
  , Record {uchar = '\10526', commands = [("base",""),("unicode-math","\\rightarrowdiamond")], category = Rel, comments = "RIGHTWARDS ARROW TO BLACK DIAMOND"}
  , Record {uchar = '\10527', commands = [("base",""),("unicode-math","\\diamondleftarrowbar")], category = Rel, comments = "LEFTWARDS ARROW FROM BAR TO BLACK DIAMOND"}
  , Record {uchar = '\10528', commands = [("base",""),("unicode-math","\\barrightarrowdiamond")], category = Rel, comments = "RIGHTWARDS ARROW FROM BAR TO BLACK DIAMOND"}
  , Record {uchar = '\10529', commands = [("base",""),("unicode-math","\\nwsearrow")], category = Rel, comments = "NORTH WEST AND SOUTH EAST ARROW"}
  , Record {uchar = '\10530', commands = [("base",""),("unicode-math","\\neswarrow")], category = Rel, comments = "NORTH EAST AND SOUTH WEST ARROW"}
  , Record {uchar = '\10531', commands = [("base",""),("unicode-math","\\hknwarrow")], category = Rel, comments = "NORTH WEST ARROW WITH HOOK"}
  , Record {uchar = '\10532', commands = [("base",""),("unicode-math","\\hknearrow")], category = Rel, comments = "NORTH EAST ARROW WITH HOOK"}
  , Record {uchar = '\10533', commands = [("base",""),("unicode-math","\\hksearow")], category = Rel, comments = "SOUTH EAST ARROW WITH HOOK"}
  , Record {uchar = '\10534', commands = [("base",""),("unicode-math","\\hkswarow")], category = Rel, comments = "SOUTH WEST ARROW WITH HOOK"}
  , Record {uchar = '\10535', commands = [("base",""),("unicode-math","\\tona")], category = Rel, comments = "NORTH WEST ARROW AND NORTH EAST ARROW"}
  , Record {uchar = '\10536', commands = [("base",""),("unicode-math","\\toea")], category = Rel, comments = "NORTH EAST ARROW AND SOUTH EAST ARROW"}
  , Record {uchar = '\10537', commands = [("base",""),("unicode-math","\\tosa")], category = Rel, comments = "SOUTH EAST ARROW AND SOUTH WEST ARROW"}
  , Record {uchar = '\10538', commands = [("base",""),("unicode-math","\\towa")], category = Rel, comments = "SOUTH WEST ARROW AND NORTH WEST ARROW"}
  , Record {uchar = '\10539', commands = [("base",""),("unicode-math","\\rdiagovfdiag")], category = Ord, comments = "RISING DIAGONAL CROSSING FALLING DIAGONAL"}
  , Record {uchar = '\10540', commands = [("base",""),("unicode-math","\\fdiagovrdiag")], category = Ord, comments = "FALLING DIAGONAL CROSSING RISING DIAGONAL"}
  , Record {uchar = '\10541', commands = [("base",""),("unicode-math","\\seovnearrow")], category = Ord, comments = "SOUTH EAST ARROW CROSSING NORTH EAST ARROW"}
  , Record {uchar = '\10542', commands = [("base",""),("unicode-math","\\neovsearrow")], category = Ord, comments = "NORTH EAST ARROW CROSSING SOUTH EAST ARROW"}
  , Record {uchar = '\10543', commands = [("base",""),("unicode-math","\\fdiagovnearrow")], category = Ord, comments = "FALLING DIAGONAL CROSSING NORTH EAST ARROW"}
  , Record {uchar = '\10544', commands = [("base",""),("unicode-math","\\rdiagovsearrow")], category = Ord, comments = "RISING DIAGONAL CROSSING SOUTH EAST ARROW"}
  , Record {uchar = '\10545', commands = [("base",""),("unicode-math","\\neovnwarrow")], category = Ord, comments = "NORTH EAST ARROW CROSSING NORTH WEST ARROW"}
  , Record {uchar = '\10546', commands = [("base",""),("unicode-math","\\nwovnearrow")], category = Ord, comments = "NORTH WEST ARROW CROSSING NORTH EAST ARROW"}
  ...
  , Record {uchar = '\10548', commands = [("base",""),("unicode-math","\\uprightcurvearrow")], category = Ord, comments = "ARROW POINTING RIGHTWARDS THEN CURVING UPWARDS"}
  , Record {uchar = '\10549', commands = [("base",""),("unicode-math","\\downrightcurvedarrow")], category = Ord, comments = "ARROW POINTING RIGHTWARDS THEN CURVING DOWNWARDS"}
  , Record {uchar = '\10550', commands = [("base",""),("unicode-math","\\leftdowncurvedarrow")], category = Rel, comments = "ARROW POINTING DOWNWARDS THEN CURVING LEFTWARDS"}
  , Record {uchar = '\10551', commands = [("base",""),("unicode-math","\\rightdowncurvedarrow")], category = Rel, comments = "ARROW POINTING DOWNWARDS THEN CURVING RIGHTWARDS"}
  , Record {uchar = '\10552', commands = [("base",""),("unicode-math","\\cwrightarcarrow")], category = Rel, comments = "RIGHT-SIDE ARC CLOCKWISE ARROW"}
  , Record {uchar = '\10553', commands = [("base",""),("unicode-math","\\acwleftarcarrow")], category = Rel, comments = "LEFT-SIDE ARC ANTICLOCKWISE ARROW"}
  , Record {uchar = '\10554', commands = [("base",""),("unicode-math","\\acwoverarcarrow")], category = Rel, comments = "TOP ARC ANTICLOCKWISE ARROW"}
  , Record {uchar = '\10555', commands = [("base",""),("unicode-math","\\acwunderarcarrow")], category = Rel, comments = "BOTTOM ARC ANTICLOCKWISE ARROW"}
  , Record {uchar = '\10556', commands = [("base",""),("unicode-math","\\curvearrowrightminus")], category = Rel, comments = "TOP ARC CLOCKWISE ARROW WITH MINUS"}
  , Record {uchar = '\10557', commands = [("base",""),("unicode-math","\\curvearrowleftplus")], category = Rel, comments = "TOP ARC ANTICLOCKWISE ARROW WITH PLUS"}
  , Record {uchar = '\10558', commands = [("base",""),("unicode-math","\\cwundercurvearrow")], category = Rel, comments = "LOWER RIGHT SEMICIRCULAR CLOCKWISE ARROW"}
  , Record {uchar = '\10559', commands = [("base",""),("unicode-math","\\ccwundercurvearrow")], category = Rel, comments = "LOWER LEFT SEMICIRCULAR ANTICLOCKWISE ARROW"}
  , Record {uchar = '\10560', commands = [("base",""),("unicode-math","\\acwcirclearrow")], category = Rel, comments = "ANTICLOCKWISE CLOSED CIRCLE ARROW"}
  , Record {uchar = '\10561', commands = [("base",""),("unicode-math","\\cwcirclearrow")], category = Rel, comments = "CLOCKWISE CLOSED CIRCLE ARROW"}
  , Record {uchar = '\10562', commands = [("base",""),("unicode-math","\\rightarrowshortleftarrow")], category = Rel, comments = "RIGHTWARDS ARROW ABOVE SHORT LEFTWARDS ARROW"}
  , Record {uchar = '\10563', commands = [("base",""),("unicode-math","\\leftarrowshortrightarrow")], category = Rel, comments = "LEFTWARDS ARROW ABOVE SHORT RIGHTWARDS ARROW"}
  , Record {uchar = '\10564', commands = [("base",""),("unicode-math","\\shortrightarrowleftarrow")], category = Rel, comments = "SHORT RIGHTWARDS ARROW ABOVE LEFTWARDS ARROW"}
  , Record {uchar = '\10565', commands = [("base",""),("unicode-math","\\rightarrowplus")], category = Rel, comments = "RIGHTWARDS ARROW WITH PLUS BELOW"}
  , Record {uchar = '\10566', commands = [("base",""),("unicode-math","\\leftarrowplus")], category = Rel, comments = "LEFTWARDS ARROW WITH PLUS BELOW"}
  , Record {uchar = '\10567', commands = [("base",""),("unicode-math","\\rightarrowx")], category = Rel, comments = "RIGHTWARDS ARROW THROUGH X"}
  , Record {uchar = '\10568', commands = [("base",""),("unicode-math","\\leftrightarrowcircle")], category = Rel, comments = "LEFT RIGHT ARROW THROUGH SMALL CIRCLE"}
  , Record {uchar = '\10569', commands = [("base",""),("unicode-math","\\twoheaduparrowcircle")], category = Rel, comments = "UPWARDS TWO-HEADED ARROW FROM SMALL CIRCLE"}
  ...
  , Record {uchar = '\10572', commands = [("base",""),("unicode-math","\\updownharpoonrightleft")], category = Rel, comments = "UP BARB RIGHT DOWN BARB LEFT HARPOON"}
  , Record {uchar = '\10573', commands = [("base",""),("unicode-math","\\updownharpoonleftright")], category = Rel, comments = "UP BARB LEFT DOWN BARB RIGHT HARPOON"}
  ...
  , Record {uchar = '\10598', commands = [("base",""),("unicode-math","\\leftrightharpoonsup")], category = Rel, comments = "LEFTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB UP"}
  , Record {uchar = '\10599', commands = [("base",""),("unicode-math","\\leftrightharpoonsdown")], category = Rel, comments = "LEFTWARDS HARPOON WITH BARB DOWN ABOVE RIGHTWARDS HARPOON WITH BARB DOWN"}
  , Record {uchar = '\10600', commands = [("base",""),("unicode-math","\\rightleftharpoonsup")], category = Rel, comments = "RIGHTWARDS HARPOON WITH BARB UP ABOVE LEFTWARDS HARPOON WITH BARB UP"}
  , Record {uchar = '\10601', commands = [("base",""),("unicode-math","\\rightleftharpoonsdown")], category = Rel, comments = "RIGHTWARDS HARPOON WITH BARB DOWN ABOVE LEFTWARDS HARPOON WITH BARB DOWN"}
  ...
  , Record {uchar = '\10608', commands = [("base",""),("unicode-math","\\rightimply")], category = Rel, comments = "RIGHT DOUBLE ARROW WITH ROUNDED HEAD"}
  , Record {uchar = '\10609', commands = [("base",""),("unicode-math","\\equalrightarrow")], category = Rel, comments = "EQUALS SIGN ABOVE RIGHTWARDS ARROW"}
  , Record {uchar = '\10610', commands = [("base",""),("unicode-math","\\similarrightarrow")], category = Rel, comments = "TILDE OPERATOR ABOVE RIGHTWARDS ARROW"}
  , Record {uchar = '\10611', commands = [("base",""),("unicode-math","\\leftarrowsimilar")], category = Rel, comments = "LEFTWARDS ARROW ABOVE TILDE OPERATOR"}
  , Record {uchar = '\10612', commands = [("base",""),("unicode-math","\\rightarrowsimilar")], category = Rel, comments = "RIGHTWARDS ARROW ABOVE TILDE OPERATOR"}
  , Record {uchar = '\10613', commands = [("base",""),("unicode-math","\\rightarrowapprox")], category = Rel, comments = "RIGHTWARDS ARROW ABOVE ALMOST EQUAL TO"}
  , Record {uchar = '\10614', commands = [("base",""),("unicode-math","\\ltlarr")], category = Rel, comments = "LESS-THAN ABOVE LEFTWARDS ARROW"}
  , Record {uchar = '\10615', commands = [("base",""),("unicode-math","\\leftarrowless")], category = Rel, comments = "LEFTWARDS ARROW THROUGH LESS-THAN"}
  , Record {uchar = '\10616', commands = [("base",""),("unicode-math","\\gtrarr")], category = Rel, comments = "GREATER-THAN ABOVE RIGHTWARDS ARROW"}
  , Record {uchar = '\10617', commands = [("base",""),("unicode-math","\\subrarr")], category = Rel, comments = "SUBSET ABOVE RIGHTWARDS ARROW"}
  , Record {uchar = '\10618', commands = [("base",""),("unicode-math","\\leftarrowsubset")], category = Rel, comments = "LEFTWARDS ARROW THROUGH SUBSET"}
  , Record {uchar = '\10619', commands = [("base",""),("unicode-math","\\suplarr")], category = Rel, comments = "SUPERSET ABOVE LEFTWARDS ARROW"}
  ...
  , Record {uchar = '\10622', commands = [("base",""),("unicode-math","\\upfishtail")], category = Rel, comments = "UP FISH TAIL"}
  , Record {uchar = '\10623', commands = [("base",""),("unicode-math","\\downfishtail")], category = Rel, comments = "DOWN FISH TAIL"}
  ...
  , Record {uchar = '\10626', commands = [("base",""),("unicode-math","\\typecolon")], category = Bin, comments = "Z NOTATION TYPE COLON, (present in bbold font but no command)"}
  , Record {uchar = '\10627', commands = [("base",""),("unicode-math","\\lBrace")], category = Open, comments = "LEFT WHITE CURLY BRACKET"}
  , Record {uchar = '\10628', commands = [("base",""),("unicode-math","\\rBrace")], category = Close, comments = "RIGHT WHITE CURLY BRACKET"}
  ...
  , Record {uchar = '\10635', commands = [("base",""),("unicode-math","\\lbrackubar")], category = Open, comments = "LEFT SQUARE BRACKET WITH UNDERBAR"}
  , Record {uchar = '\10636', commands = [("base",""),("unicode-math","\\rbrackubar")], category = Close, comments = "RIGHT SQUARE BRACKET WITH UNDERBAR"}
  , Record {uchar = '\10637', commands = [("base",""),("unicode-math","\\lbrackultick")], category = Open, comments = "LEFT SQUARE BRACKET WITH TICK IN TOP CORNER"}
  , Record {uchar = '\10638', commands = [("base",""),("unicode-math","\\rbracklrtick")], category = Close, comments = "RIGHT SQUARE BRACKET WITH TICK IN BOTTOM CORNER"}
  , Record {uchar = '\10639', commands = [("base",""),("unicode-math","\\lbracklltick")], category = Open, comments = "LEFT SQUARE BRACKET WITH TICK IN BOTTOM CORNER"}
  , Record {uchar = '\10640', commands = [("base",""),("unicode-math","\\rbrackurtick")], category = Close, comments = "RIGHT SQUARE BRACKET WITH TICK IN TOP CORNER"}
  , Record {uchar = '\10641', commands = [("base",""),("unicode-math","\\langledot")], category = Open, comments = "LEFT ANGLE BRACKET WITH DOT"}
  , Record {uchar = '\10642', commands = [("base",""),("unicode-math","\\rangledot")], category = Close, comments = "RIGHT ANGLE BRACKET WITH DOT"}
  , Record {uchar = '\10643', commands = [("base",""),("unicode-math","\\lparenless")], category = Open, comments = "LEFT ARC LESS-THAN BRACKET"}
  , Record {uchar = '\10644', commands = [("base",""),("unicode-math","\\rparengtr")], category = Close, comments = "RIGHT ARC GREATER-THAN BRACKET"}
  , Record {uchar = '\10645', commands = [("base",""),("unicode-math","\\Lparengtr")], category = Open, comments = "DOUBLE LEFT ARC GREATER-THAN BRACKET"}
  , Record {uchar = '\10646', commands = [("base",""),("unicode-math","\\Rparenless")], category = Close, comments = "DOUBLE RIGHT ARC LESS-THAN BRACKET"}
  , Record {uchar = '\10647', commands = [("base",""),("unicode-math","\\lblkbrbrak")], category = Open, comments = "LEFT BLACK TORTOISE SHELL BRACKET"}
  , Record {uchar = '\10648', commands = [("base",""),("unicode-math","\\rblkbrbrak")], category = Close, comments = "RIGHT BLACK TORTOISE SHELL BRACKET"}
  , Record {uchar = '\10649', commands = [("base",""),("unicode-math","\\fourvdots")], category = Ord, comments = "DOTTED FENCE"}
  , Record {uchar = '\10650', commands = [("base",""),("unicode-math","\\vzigzag")], category = Ord, comments = "VERTICAL ZIGZAG LINE"}
  , Record {uchar = '\10651', commands = [("base",""),("unicode-math","\\measuredangleleft")], category = Ord, comments = "MEASURED ANGLE OPENING LEFT"}
  , Record {uchar = '\10652', commands = [("base",""),("unicode-math","\\rightanglesqr")], category = Ord, comments = "RIGHT ANGLE VARIANT WITH SQUARE"}
  , Record {uchar = '\10653', commands = [("base",""),("unicode-math","\\rightanglemdot")], category = Ord, comments = "MEASURED RIGHT ANGLE WITH DOT"}
  , Record {uchar = '\10654', commands = [("base",""),("unicode-math","\\angles")], category = Ord, comments = "ANGLE WITH S INSIDE"}
  , Record {uchar = '\10655', commands = [("base",""),("unicode-math","\\angdnr")], category = Ord, comments = "ACUTE ANGLE"}
  , Record {uchar = '\10656', commands = [("base",""),("unicode-math","\\gtlpar")], category = Ord, comments = "SPHERICAL ANGLE OPENING LEFT"}
  , Record {uchar = '\10657', commands = [("base",""),("unicode-math","\\sphericalangleup")], category = Ord, comments = "SPHERICAL ANGLE OPENING UP"}
  , Record {uchar = '\10658', commands = [("base",""),("unicode-math","\\turnangle")], category = Ord, comments = "TURNED ANGLE"}
  , Record {uchar = '\10659', commands = [("base",""),("unicode-math","\\revangle")], category = Ord, comments = "REVERSED ANGLE"}
  , Record {uchar = '\10660', commands = [("base",""),("unicode-math","\\angleubar")], category = Ord, comments = "ANGLE WITH UNDERBAR"}
  , Record {uchar = '\10661', commands = [("base",""),("unicode-math","\\revangleubar")], category = Ord, comments = "REVERSED ANGLE WITH UNDERBAR"}
  , Record {uchar = '\10662', commands = [("base",""),("unicode-math","\\wideangledown")], category = Ord, comments = "OBLIQUE ANGLE OPENING UP"}
  , Record {uchar = '\10663', commands = [("base",""),("unicode-math","\\wideangleup")], category = Ord, comments = "OBLIQUE ANGLE OPENING DOWN"}
  , Record {uchar = '\10664', commands = [("base",""),("unicode-math","\\measanglerutone")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING UP AND RIGHT"}
  , Record {uchar = '\10665', commands = [("base",""),("unicode-math","\\measanglelutonw")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING UP AND LEFT"}
  , Record {uchar = '\10666', commands = [("base",""),("unicode-math","\\measanglerdtose")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING DOWN AND RIGHT"}
  , Record {uchar = '\10667', commands = [("base",""),("unicode-math","\\measangleldtosw")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING DOWN AND LEFT"}
  , Record {uchar = '\10668', commands = [("base",""),("unicode-math","\\measangleurtone")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING RIGHT AND UP"}
  , Record {uchar = '\10669', commands = [("base",""),("unicode-math","\\measangleultonw")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING LEFT AND UP"}
  , Record {uchar = '\10670', commands = [("base",""),("unicode-math","\\measangledrtose")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING RIGHT AND DOWN"}
  , Record {uchar = '\10671', commands = [("base",""),("unicode-math","\\measangledltosw")], category = Ord, comments = "MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING LEFT AND DOWN"}
  , Record {uchar = '\10672', commands = [("base",""),("unicode-math","\\revemptyset")], category = Ord, comments = "REVERSED EMPTY SET"}
  , Record {uchar = '\10673', commands = [("base",""),("unicode-math","\\emptysetobar")], category = Ord, comments = "EMPTY SET WITH OVERBAR"}
  , Record {uchar = '\10674', commands = [("base",""),("unicode-math","\\emptysetocirc")], category = Ord, comments = "EMPTY SET WITH SMALL CIRCLE ABOVE"}
  , Record {uchar = '\10675', commands = [("base",""),("unicode-math","\\emptysetoarr")], category = Ord, comments = "EMPTY SET WITH RIGHT ARROW ABOVE"}
  , Record {uchar = '\10676', commands = [("base",""),("unicode-math","\\emptysetoarrl")], category = Ord, comments = "EMPTY SET WITH LEFT ARROW ABOVE"}
  , Record {uchar = '\10677', commands = [("base",""),("unicode-math","\\circlehbar")], category = Bin, comments = "CIRCLE WITH HORIZONTAL BAR"}
  , Record {uchar = '\10678', commands = [("base",""),("unicode-math","\\circledvert")], category = Bin, comments = "CIRCLED VERTICAL BAR"}
  , Record {uchar = '\10679', commands = [("base",""),("unicode-math","\\circledparallel")], category = Bin, comments = "CIRCLED PARALLEL"}
  , Record {uchar = '\10680', commands = [("txfonts","\\circledbslash"),("unicode-math","\\obslash")], category = Bin, comments = "CIRCLED REVERSE SOLIDUS"}
  , Record {uchar = '\10681', commands = [("base",""),("unicode-math","\\operp")], category = Bin, comments = "CIRCLED PERPENDICULAR"}
  , Record {uchar = '\10682', commands = [("base",""),("unicode-math","\\obot")], category = Ord, comments = "CIRCLE DIVIDED BY HORIZONTAL BAR AND TOP HALF DIVIDED BY VERTICAL BAR"}
  , Record {uchar = '\10683', commands = [("base",""),("unicode-math","\\olcross")], category = Ord, comments = "CIRCLE WITH SUPERIMPOSED X"}
  , Record {uchar = '\10684', commands = [("base",""),("unicode-math","\\odotslashdot")], category = Ord, comments = "CIRCLED ANTICLOCKWISE-ROTATED DIVISION SIGN"}
  , Record {uchar = '\10685', commands = [("base",""),("unicode-math","\\uparrowoncircle")], category = Ord, comments = "UP ARROW THROUGH CIRCLE"}
  , Record {uchar = '\10686', commands = [("base",""),("unicode-math","\\circledwhitebullet")], category = Ord, comments = "CIRCLED WHITE BULLET"}
  , Record {uchar = '\10687', commands = [("base",""),("unicode-math","\\circledbullet")], category = Ord, comments = "CIRCLED BULLET"}
  ...
  , Record {uchar = '\10690', commands = [("base",""),("unicode-math","\\cirscir")], category = Ord, comments = "CIRCLE WITH SMALL CIRCLE TO THE RIGHT"}
  , Record {uchar = '\10691', commands = [("base",""),("unicode-math","\\cirE")], category = Ord, comments = "CIRCLE WITH TWO HORIZONTAL STROKES TO THE RIGHT"}
  ...
  , Record {uchar = '\10697', commands = [("base",""),("unicode-math","\\boxonbox")], category = Ord, comments = "TWO JOINED SQUARES"}
  , Record {uchar = '\10698', commands = [("base",""),("unicode-math","\\triangleodot")], category = Ord, comments = "TRIANGLE WITH DOT ABOVE"}
  , Record {uchar = '\10699', commands = [("base",""),("unicode-math","\\triangleubar")], category = Ord, comments = "TRIANGLE WITH UNDERBAR"}
  , Record {uchar = '\10700', commands = [("base",""),("unicode-math","\\triangles")], category = Ord, comments = "S IN TRIANGLE"}
  , Record {uchar = '\10701', commands = [("base",""),("unicode-math","\\triangleserifs")], category = Bin, comments = "TRIANGLE WITH SERIFS AT BOTTOM"}
  , Record {uchar = '\10702', commands = [("base",""),("unicode-math","\\rtriltri")], category = Rel, comments = "RIGHT TRIANGLE ABOVE LEFT TRIANGLE"}
  ...
  , Record {uchar = '\10705', commands = [("base",""),("unicode-math","\\lfbowtie")], category = Rel, comments = "left black bowtie"}
  , Record {uchar = '\10706', commands = [("base",""),("unicode-math","\\rfbowtie")], category = Rel, comments = "right black bowtie"}
  , Record {uchar = '\10707', commands = [("base",""),("unicode-math","\\fbowtie")], category = Rel, comments = "BLACK BOWTIE"}
  , Record {uchar = '\10708', commands = [("base",""),("unicode-math","\\lftimes")], category = Rel, comments = "left black times"}
  , Record {uchar = '\10709', commands = [("base",""),("unicode-math","\\rftimes")], category = Rel, comments = "right black times"}
  , Record {uchar = '\10710', commands = [("base",""),("unicode-math","\\hourglass")], category = Bin, comments = "WHITE HOURGLASS"}
  , Record {uchar = '\10711', commands = [("base",""),("unicode-math","\\blackhourglass")], category = Bin, comments = "BLACK HOURGLASS"}
  , Record {uchar = '\10712', commands = [("base",""),("unicode-math","\\lvzigzag")], category = Open, comments = "LEFT WIGGLY FENCE"}
  , Record {uchar = '\10713', commands = [("base",""),("unicode-math","\\rvzigzag")], category = Close, comments = "RIGHT WIGGLY FENCE"}
  , Record {uchar = '\10714', commands = [("base",""),("unicode-math","\\Lvzigzag")], category = Open, comments = "LEFT DOUBLE WIGGLY FENCE"}
  , Record {uchar = '\10715', commands = [("base",""),("unicode-math","\\Rvzigzag")], category = Close, comments = "RIGHT DOUBLE WIGGLY FENCE"}
  , Record {uchar = '\10716', commands = [("base",""),("unicode-math","\\iinfin")], category = Ord, comments = "INCOMPLETE INFINITY"}
  , Record {uchar = '\10717', commands = [("base",""),("unicode-math","\\tieinfty")], category = Ord, comments = "TIE OVER INFINITY"}
  , Record {uchar = '\10718', commands = [("base",""),("unicode-math","\\nvinfty")], category = Ord, comments = "INFINITY NEGATED WITH VERTICAL BAR"}
  , Record {uchar = '\10719', commands = [("txfonts","\\multimapboth"),("unicode-math","\\dualmap")], category = Rel, comments = "DOUBLE-ENDED MULTIMAP"}
  , Record {uchar = '\10720', commands = [("base",""),("unicode-math","\\laplac")], category = Ord, comments = "SQUARE WITH CONTOURED OUTLINE"}
  , Record {uchar = '\10721', commands = [("base",""),("unicode-math","\\lrtriangleeq")], category = Rel, comments = "INCREASES AS"}
  , Record {uchar = '\10722', commands = [("base",""),("unicode-math","\\shuffle")], category = Bin, comments = "SHUFFLE PRODUCT"}
  , Record {uchar = '\10723', commands = [("base",""),("unicode-math","\\eparsl")], category = Rel, comments = "EQUALS SIGN AND SLANTED PARALLEL"}
  , Record {uchar = '\10724', commands = [("base",""),("unicode-math","\\smeparsl")], category = Rel, comments = "EQUALS SIGN AND SLANTED PARALLEL WITH TILDE ABOVE"}
  , Record {uchar = '\10725', commands = [("base",""),("unicode-math","\\eqvparsl")], category = Rel, comments = "IDENTICAL TO AND SLANTED PARALLEL"}
  , Record {uchar = '\10726', commands = [("base",""),("unicode-math","\\gleichstark")], category = Rel, comments = "GLEICH STARK"}
  , Record {uchar = '\10727', commands = [("base",""),("unicode-math","\\thermod")], category = Ord, comments = "THERMODYNAMIC"}
  , Record {uchar = '\10728', commands = [("base",""),("unicode-math","\\downtriangleleftblack")], category = Ord, comments = "DOWN-POINTING TRIANGLE WITH LEFT HALF BLACK"}
  , Record {uchar = '\10729', commands = [("base",""),("unicode-math","\\downtrianglerightblack")], category = Ord, comments = "DOWN-POINTING TRIANGLE WITH RIGHT HALF BLACK"}
  , Record {uchar = '\10730', commands = [("base",""),("unicode-math","\\blackdiamonddownarrow")], category = Ord, comments = "BLACK DIAMOND WITH DOWN ARROW"}
  , Record {uchar = '\10731', commands = [("amssymb","\\blacklozenge"),("unicode-math","\\mdlgblklozenge")], category = Bin, comments = "BLACK LOZENGE"}
  , Record {uchar = '\10732', commands = [("base",""),("unicode-math","\\circledownarrow")], category = Ord, comments = "WHITE CIRCLE WITH DOWN ARROW"}
  , Record {uchar = '\10733', commands = [("base",""),("unicode-math","\\blackcircledownarrow")], category = Ord, comments = "BLACK CIRCLE WITH DOWN ARROW"}
  , Record {uchar = '\10734', commands = [("base",""),("unicode-math","\\errbarsquare")], category = Ord, comments = "ERROR-BARRED WHITE SQUARE"}
  , Record {uchar = '\10735', commands = [("base",""),("unicode-math","\\errbarblacksquare")], category = Ord, comments = "ERROR-BARRED BLACK SQUARE"}
  , Record {uchar = '\10736', commands = [("base",""),("unicode-math","\\errbardiamond")], category = Ord, comments = "ERROR-BARRED WHITE DIAMOND"}
  , Record {uchar = '\10737', commands = [("base",""),("unicode-math","\\errbarblackdiamond")], category = Ord, comments = "ERROR-BARRED BLACK DIAMOND"}
  , Record {uchar = '\10738', commands = [("base",""),("unicode-math","\\errbarcircle")], category = Ord, comments = "ERROR-BARRED WHITE CIRCLE"}
  , Record {uchar = '\10739', commands = [("base",""),("unicode-math","\\errbarblackcircle")], category = Ord, comments = "ERROR-BARRED BLACK CIRCLE"}
  , Record {uchar = '\10740', commands = [("base",""),("unicode-math","\\ruledelayed")], category = Rel, comments = "RULE-DELAYED"}
  , Record {uchar = '\10741', commands = [("base","\\setminus"),("unicode-math","\\setminus")], category = Bin, comments = "REVERSE SOLIDUS OPERATOR"}
  , Record {uchar = '\10742', commands = [("base",""),("unicode-math","\\dsol")], category = Bin, comments = "SOLIDUS WITH OVERBAR"}
  , Record {uchar = '\10743', commands = [("base",""),("unicode-math","\\rsolbar")], category = Bin, comments = "REVERSE SOLIDUS WITH HORIZONTAL STROKE"}
  , Record {uchar = '\10744', commands = [("base",""),("unicode-math","\\xsol")], category = Op, comments = "BIG SOLIDUS"}
  ...
  , Record {uchar = '\10746', commands = [("base",""),("unicode-math","\\doubleplus")], category = Bin, comments = "DOUBLE PLUS"}
  , Record {uchar = '\10747', commands = [("base",""),("unicode-math","\\tripleplus")], category = Bin, comments = "TRIPLE PLUS"}
  , Record {uchar = '\10748', commands = [("base",""),("unicode-math","\\lcurvyangle")], category = Open, comments = "left pointing curved angle bracket"}
  , Record {uchar = '\10749', commands = [("base",""),("unicode-math","\\rcurvyangle")], category = Close, comments = "right pointing curved angle bracket"}
  , Record {uchar = '\10750', commands = [("base",""),("unicode-math","\\tplus")], category = Bin, comments = "TINY"}
  , Record {uchar = '\10751', commands = [("base",""),("unicode-math","\\tminus")], category = Bin, comments = "MINY"}
  ...
  , Record {uchar = '\10755', commands = [("base",""),("unicode-math","\\bigcupdot")], category = Op, comments = "N-ARY UNION OPERATOR WITH DOT"}
  ...
  , Record {uchar = '\10759', commands = [("base",""),("unicode-math","\\conjquant")], category = Op, comments = "TWO LOGICAL AND OPERATOR"}
  , Record {uchar = '\10760', commands = [("base",""),("unicode-math","\\disjquant")], category = Op, comments = "TWO LOGICAL OR OPERATOR"}
  , Record {uchar = '\10761', commands = [("txfonts","\\varprod"),("unicode-math","\\bigtimes")], category = Op, comments = "N-ARY TIMES OPERATOR"}
  , Record {uchar = '\10762', commands = [("base",""),("unicode-math","\\modtwosum")], category = Ord, comments = "MODULO TWO SUM"}
  , Record {uchar = '\10763', commands = [("base",""),("unicode-math","\\sumint")], category = Op, comments = "SUMMATION WITH INTEGRAL"}
  ...
  , Record {uchar = '\10765', commands = [("base",""),("unicode-math","\\intbar")], category = Op, comments = "FINITE PART INTEGRAL"}
  , Record {uchar = '\10766', commands = [("base",""),("unicode-math","\\intBar")], category = Op, comments = "INTEGRAL WITH DOUBLE STROKE"}
  , Record {uchar = '\10767', commands = [("esint","\\fint"),("wrisym","\\fint"),("unicode-math","\\fint")], category = Op, comments = "INTEGRAL AVERAGE WITH SLASH"}
  , Record {uchar = '\10768', commands = [("base",""),("unicode-math","\\cirfnint")], category = Op, comments = "CIRCULATION FUNCTION"}
  , Record {uchar = '\10769', commands = [("base",""),("unicode-math","\\awint")], category = Op, comments = "ANTICLOCKWISE INTEGRATION"}
  , Record {uchar = '\10770', commands = [("base",""),("unicode-math","\\rppolint")], category = Op, comments = "LINE INTEGRATION WITH RECTANGULAR PATH AROUND POLE"}
  , Record {uchar = '\10771', commands = [("base",""),("unicode-math","\\scpolint")], category = Op, comments = "LINE INTEGRATION WITH SEMICIRCULAR PATH AROUND POLE"}
  , Record {uchar = '\10772', commands = [("base",""),("unicode-math","\\npolint")], category = Op, comments = "LINE INTEGRATION NOT INCLUDING THE POLE"}
  , Record {uchar = '\10773', commands = [("base",""),("unicode-math","\\pointint")], category = Op, comments = "INTEGRAL AROUND A POINT OPERATOR"}
  ...
  , Record {uchar = '\10775', commands = [("base",""),("unicode-math","\\intlarhk")], category = Op, comments = "INTEGRAL WITH LEFTWARDS ARROW WITH HOOK"}
  , Record {uchar = '\10776', commands = [("base",""),("unicode-math","\\intx")], category = Op, comments = "INTEGRAL WITH TIMES SIGN"}
  , Record {uchar = '\10777', commands = [("base",""),("unicode-math","\\intcap")], category = Op, comments = "INTEGRAL WITH INTERSECTION"}
  , Record {uchar = '\10778', commands = [("base",""),("unicode-math","\\intcup")], category = Op, comments = "INTEGRAL WITH UNION"}
  , Record {uchar = '\10779', commands = [("base",""),("unicode-math","\\upint")], category = Op, comments = "INTEGRAL WITH OVERBAR"}
  , Record {uchar = '\10780', commands = [("base",""),("unicode-math","\\lowint")], category = Op, comments = "INTEGRAL WITH UNDERBAR"}
  , Record {uchar = '\10781', commands = [("amssymb","\\Join"),("unicode-math","\\Join")], category = Op, comments = "JOIN"}
  , Record {uchar = '\10782', commands = [("base",""),("unicode-math","\\bigtriangleleft")], category = Op, comments = "LARGE LEFT TRIANGLE OPERATOR"}
  ...
  , Record {uchar = '\10786', commands = [("base",""),("unicode-math","\\ringplus")], category = Bin, comments = "PLUS SIGN WITH SMALL CIRCLE ABOVE"}
  , Record {uchar = '\10787', commands = [("base",""),("unicode-math","\\plushat")], category = Bin, comments = "PLUS SIGN WITH CIRCUMFLEX ACCENT ABOVE"}
  , Record {uchar = '\10788', commands = [("base",""),("unicode-math","\\simplus")], category = Bin, comments = "PLUS SIGN WITH TILDE ABOVE"}
  , Record {uchar = '\10789', commands = [("base",""),("unicode-math","\\plusdot")], category = Bin, comments = "PLUS SIGN WITH DOT BELOW"}
  , Record {uchar = '\10790', commands = [("base",""),("unicode-math","\\plussim")], category = Bin, comments = "PLUS SIGN WITH TILDE BELOW"}
  , Record {uchar = '\10791', commands = [("base",""),("unicode-math","\\plussubtwo")], category = Bin, comments = "PLUS SIGN WITH SUBSCRIPT TWO"}
  , Record {uchar = '\10792', commands = [("base",""),("unicode-math","\\plustrif")], category = Bin, comments = "PLUS SIGN WITH BLACK TRIANGLE"}
  , Record {uchar = '\10793', commands = [("base",""),("unicode-math","\\commaminus")], category = Bin, comments = "MINUS SIGN WITH COMMA ABOVE"}
  , Record {uchar = '\10794', commands = [("base",""),("unicode-math","\\minusdot")], category = Bin, comments = "MINUS SIGN WITH DOT BELOW"}
  , Record {uchar = '\10795', commands = [("base",""),("unicode-math","\\minusfdots")], category = Bin, comments = "MINUS SIGN WITH FALLING DOTS"}
  , Record {uchar = '\10796', commands = [("base",""),("unicode-math","\\minusrdots")], category = Bin, comments = "MINUS SIGN WITH RISING DOTS"}
  , Record {uchar = '\10797', commands = [("base",""),("unicode-math","\\opluslhrim")], category = Bin, comments = "PLUS SIGN IN LEFT HALF CIRCLE"}
  , Record {uchar = '\10798', commands = [("base",""),("unicode-math","\\oplusrhrim")], category = Bin, comments = "PLUS SIGN IN RIGHT HALF CIRCLE"}
  , Record {uchar = '\10799', commands = [("base",""),("base","\\times"),("unicode-math","\\vectimes")], category = Bin, comments = "VECTOR OR CROSS PRODUCT"}
  , Record {uchar = '\10800', commands = [("base",""),("unicode-math","\\dottimes")], category = Bin, comments = "MULTIPLICATION SIGN WITH DOT ABOVE"}
  , Record {uchar = '\10801', commands = [("base",""),("unicode-math","\\timesbar")], category = Bin, comments = "MULTIPLICATION SIGN WITH UNDERBAR"}
  , Record {uchar = '\10802', commands = [("base",""),("unicode-math","\\btimes")], category = Bin, comments = "SEMIDIRECT PRODUCT WITH BOTTOM CLOSED"}
  , Record {uchar = '\10803', commands = [("base",""),("unicode-math","\\smashtimes")], category = Bin, comments = "SMASH PRODUCT"}
  , Record {uchar = '\10804', commands = [("base",""),("unicode-math","\\otimeslhrim")], category = Bin, comments = "MULTIPLICATION SIGN IN LEFT HALF CIRCLE"}
  , Record {uchar = '\10805', commands = [("base",""),("unicode-math","\\otimesrhrim")], category = Bin, comments = "MULTIPLICATION SIGN IN RIGHT HALF CIRCLE"}
  , Record {uchar = '\10806', commands = [("base",""),("unicode-math","\\otimeshat")], category = Bin, comments = "CIRCLED MULTIPLICATION SIGN WITH CIRCUMFLEX ACCENT"}
  , Record {uchar = '\10807', commands = [("base",""),("unicode-math","\\Otimes")], category = Bin, comments = "MULTIPLICATION SIGN IN DOUBLE CIRCLE"}
  , Record {uchar = '\10808', commands = [("base",""),("unicode-math","\\odiv")], category = Bin, comments = "CIRCLED DIVISION SIGN"}
  , Record {uchar = '\10809', commands = [("base",""),("unicode-math","\\triangleplus")], category = Bin, comments = "PLUS SIGN IN TRIANGLE"}
  , Record {uchar = '\10810', commands = [("base",""),("unicode-math","\\triangleminus")], category = Bin, comments = "MINUS SIGN IN TRIANGLE"}
  , Record {uchar = '\10811', commands = [("base",""),("unicode-math","\\triangletimes")], category = Bin, comments = "MULTIPLICATION SIGN IN TRIANGLE"}
  , Record {uchar = '\10812', commands = [("base",""),("unicode-math","\\intprod")], category = Bin, comments = "INTERIOR PRODUCT"}
  , Record {uchar = '\10813', commands = [("base",""),("unicode-math","\\intprodr")], category = Bin, comments = "RIGHTHAND INTERIOR PRODUCT"}
  ...
  , Record {uchar = '\10816', commands = [("base",""),("unicode-math","\\capdot")], category = Bin, comments = "INTERSECTION WITH DOT"}
  , Record {uchar = '\10817', commands = [("base",""),("unicode-math","\\uminus")], category = Bin, comments = "UNION WITH MINUS SIGN, z notation bag subtraction"}
  , Record {uchar = '\10818', commands = [("base",""),("unicode-math","\\barcup")], category = Bin, comments = "UNION WITH OVERBAR"}
  , Record {uchar = '\10819', commands = [("base",""),("unicode-math","\\barcap")], category = Bin, comments = "INTERSECTION WITH OVERBAR"}
  , Record {uchar = '\10820', commands = [("base",""),("unicode-math","\\capwedge")], category = Bin, comments = "INTERSECTION WITH LOGICAL AND"}
  , Record {uchar = '\10821', commands = [("base",""),("unicode-math","\\cupvee")], category = Bin, comments = "UNION WITH LOGICAL OR"}
  , Record {uchar = '\10822', commands = [("base",""),("unicode-math","\\cupovercap")], category = Bin, comments = "UNION ABOVE INTERSECTION"}
  , Record {uchar = '\10823', commands = [("base",""),("unicode-math","\\capovercup")], category = Bin, comments = "INTERSECTION ABOVE UNION"}
  , Record {uchar = '\10824', commands = [("base",""),("unicode-math","\\cupbarcap")], category = Bin, comments = "UNION ABOVE BAR ABOVE INTERSECTION"}
  , Record {uchar = '\10825', commands = [("base",""),("unicode-math","\\capbarcup")], category = Bin, comments = "INTERSECTION ABOVE BAR ABOVE UNION"}
  , Record {uchar = '\10826', commands = [("base",""),("unicode-math","\\twocups")], category = Bin, comments = "UNION BESIDE AND JOINED WITH UNION"}
  , Record {uchar = '\10827', commands = [("base",""),("unicode-math","\\twocaps")], category = Bin, comments = "INTERSECTION BESIDE AND JOINED WITH INTERSECTION"}
  , Record {uchar = '\10828', commands = [("base",""),("unicode-math","\\closedvarcup")], category = Bin, comments = "CLOSED UNION WITH SERIFS"}
  , Record {uchar = '\10829', commands = [("base",""),("unicode-math","\\closedvarcap")], category = Bin, comments = "CLOSED INTERSECTION WITH SERIFS"}
  , Record {uchar = '\10830', commands = [("base",""),("unicode-math","\\Sqcap")], category = Bin, comments = "DOUBLE SQUARE INTERSECTION"}
  , Record {uchar = '\10831', commands = [("base",""),("unicode-math","\\Sqcup")], category = Bin, comments = "DOUBLE SQUARE UNION"}
  , Record {uchar = '\10832', commands = [("base",""),("unicode-math","\\closedvarcupsmashprod")], category = Bin, comments = "CLOSED UNION WITH SERIFS AND SMASH PRODUCT"}
  , Record {uchar = '\10833', commands = [("base",""),("unicode-math","\\wedgeodot")], category = Bin, comments = "LOGICAL AND WITH DOT ABOVE"}
  , Record {uchar = '\10834', commands = [("base",""),("unicode-math","\\veeodot")], category = Bin, comments = "LOGICAL OR WITH DOT ABOVE"}
  , Record {uchar = '\10835', commands = [("base",""),("unicode-math","\\Wedge")], category = Bin, comments = "DOUBLE LOGICAL AND"}
  , Record {uchar = '\10836', commands = [("base",""),("unicode-math","\\Vee")], category = Bin, comments = "DOUBLE LOGICAL OR"}
  , Record {uchar = '\10837', commands = [("base",""),("unicode-math","\\wedgeonwedge")], category = Bin, comments = "TWO INTERSECTING LOGICAL AND"}
  , Record {uchar = '\10838', commands = [("base",""),("unicode-math","\\veeonvee")], category = Bin, comments = "TWO INTERSECTING LOGICAL OR"}
  , Record {uchar = '\10839', commands = [("base",""),("unicode-math","\\bigslopedvee")], category = Bin, comments = "SLOPING LARGE OR"}
  , Record {uchar = '\10840', commands = [("base",""),("unicode-math","\\bigslopedwedge")], category = Bin, comments = "SLOPING LARGE AND"}
  , Record {uchar = '\10841', commands = [("base",""),("unicode-math","\\veeonwedge")], category = Rel, comments = "LOGICAL OR OVERLAPPING LOGICAL AND"}
  , Record {uchar = '\10842', commands = [("base",""),("unicode-math","\\wedgemidvert")], category = Bin, comments = "LOGICAL AND WITH MIDDLE STEM"}
  , Record {uchar = '\10843', commands = [("base",""),("unicode-math","\\veemidvert")], category = Bin, comments = "LOGICAL OR WITH MIDDLE STEM"}
  , Record {uchar = '\10844', commands = [("base",""),("unicode-math","\\midbarwedge")], category = Bin, comments = "ogical and with horizontal dash"}
  , Record {uchar = '\10845', commands = [("base",""),("unicode-math","\\midbarvee")], category = Bin, comments = "LOGICAL OR WITH HORIZONTAL DASH"}
  ...
  , Record {uchar = '\10847', commands = [("base",""),("unicode-math","\\wedgebar")], category = Bin, comments = "LOGICAL AND WITH UNDERBAR"}
  , Record {uchar = '\10848', commands = [("base",""),("unicode-math","\\wedgedoublebar")], category = Bin, comments = "LOGICAL AND WITH DOUBLE UNDERBAR"}
  , Record {uchar = '\10849', commands = [("base",""),("unicode-math","\\varveebar")], category = Bin, comments = "SMALL VEE WITH UNDERBAR"}
  , Record {uchar = '\10850', commands = [("base",""),("unicode-math","\\doublebarvee")], category = Bin, comments = "LOGICAL OR WITH DOUBLE OVERBAR"}
  , Record {uchar = '\10851', commands = [("base",""),("unicode-math","\\veedoublebar")], category = Bin, comments = "LOGICAL OR WITH DOUBLE UNDERBAR"}
  ...
  , Record {uchar = '\10854', commands = [("base",""),("unicode-math","\\eqdot")], category = Rel, comments = "EQUALS SIGN WITH DOT BELOW"}
  , Record {uchar = '\10855', commands = [("base",""),("unicode-math","\\dotequiv")], category = Rel, comments = "IDENTICAL WITH DOT ABOVE"}
  , Record {uchar = '\10856', commands = [("base",""),("unicode-math","\\equivVert")], category = Rel, comments = "TRIPLE HORIZONTAL BAR WITH DOUBLE VERTICAL STROKE"}
  , Record {uchar = '\10857', commands = [("base",""),("unicode-math","\\equivVvert")], category = Rel, comments = "TRIPLE HORIZONTAL BAR WITH TRIPLE VERTICAL STROKE"}
  , Record {uchar = '\10858', commands = [("base",""),("unicode-math","\\dotsim")], category = Rel, comments = "TILDE OPERATOR WITH DOT ABOVE"}
  , Record {uchar = '\10859', commands = [("base",""),("unicode-math","\\simrdots")], category = Rel, comments = "TILDE OPERATOR WITH RISING DOTS"}
  , Record {uchar = '\10860', commands = [("base",""),("unicode-math","\\simminussim")], category = Rel, comments = "SIMILAR MINUS SIMILAR"}
  , Record {uchar = '\10861', commands = [("base",""),("unicode-math","\\congdot")], category = Rel, comments = "CONGRUENT WITH DOT ABOVE"}
  , Record {uchar = '\10862', commands = [("base",""),("unicode-math","\\asteq")], category = Rel, comments = "EQUALS WITH ASTERISK"}
  , Record {uchar = '\10863', commands = [("base",""),("unicode-math","\\hatapprox")], category = Rel, comments = "ALMOST EQUAL TO WITH CIRCUMFLEX ACCENT"}
  , Record {uchar = '\10864', commands = [("base",""),("unicode-math","\\approxeqq")], category = Rel, comments = "APPROXIMATELY EQUAL OR EQUAL TO"}
  , Record {uchar = '\10865', commands = [("base",""),("unicode-math","\\eqqplus")], category = Bin, comments = "EQUALS SIGN ABOVE PLUS SIGN"}
  , Record {uchar = '\10866', commands = [("base",""),("unicode-math","\\pluseqq")], category = Bin, comments = "PLUS SIGN ABOVE EQUALS SIGN"}
  , Record {uchar = '\10867', commands = [("base",""),("unicode-math","\\eqqsim")], category = Rel, comments = "EQUALS SIGN ABOVE TILDE OPERATOR"}
  ...
  , Record {uchar = '\10871', commands = [("base",""),("unicode-math","\\ddotseq")], category = Rel, comments = "EQUALS SIGN WITH TWO DOTS ABOVE AND TWO DOTS BELOW"}
  , Record {uchar = '\10872', commands = [("base",""),("unicode-math","\\equivDD")], category = Rel, comments = "EQUIVALENT WITH FOUR DOTS ABOVE"}
  , Record {uchar = '\10873', commands = [("base",""),("unicode-math","\\ltcir")], category = Rel, comments = "LESS-THAN WITH CIRCLE INSIDE"}
  , Record {uchar = '\10874', commands = [("base",""),("unicode-math","\\gtcir")], category = Rel, comments = "GREATER-THAN WITH CIRCLE INSIDE"}
  , Record {uchar = '\10875', commands = [("base",""),("unicode-math","\\ltquest")], category = Rel, comments = "LESS-THAN WITH QUESTION MARK ABOVE"}
  , Record {uchar = '\10876', commands = [("base",""),("unicode-math","\\gtquest")], category = Rel, comments = "GREATER-THAN WITH QUESTION MARK ABOVE"}
  ...
  , Record {uchar = '\10879', commands = [("base",""),("unicode-math","\\lesdot")], category = Rel, comments = "LESS-THAN OR SLANTED EQUAL TO WITH DOT INSIDE"}
  , Record {uchar = '\10880', commands = [("base",""),("unicode-math","\\gesdot")], category = Rel, comments = "GREATER-THAN OR SLANTED EQUAL TO WITH DOT INSIDE"}
  , Record {uchar = '\10881', commands = [("base",""),("unicode-math","\\lesdoto")], category = Rel, comments = "LESS-THAN OR SLANTED EQUAL TO WITH DOT ABOVE"}
  , Record {uchar = '\10882', commands = [("base",""),("unicode-math","\\gesdoto")], category = Rel, comments = "GREATER-THAN OR SLANTED EQUAL TO WITH DOT ABOVE"}
  , Record {uchar = '\10883', commands = [("base",""),("unicode-math","\\lesdotor")], category = Rel, comments = "LESS-THAN OR SLANTED EQUAL TO WITH DOT ABOVE RIGHT"}
  , Record {uchar = '\10884', commands = [("base",""),("unicode-math","\\gesdotol")], category = Rel, comments = "GREATER-THAN OR SLANTED EQUAL TO WITH DOT ABOVE LEFT"}
  ...
  , Record {uchar = '\10893', commands = [("base",""),("unicode-math","\\lsime")], category = Rel, comments = "LESS-THAN ABOVE SIMILAR OR EQUAL"}
  , Record {uchar = '\10894', commands = [("base",""),("unicode-math","\\gsime")], category = Rel, comments = "GREATER-THAN ABOVE SIMILAR OR EQUAL"}
  , Record {uchar = '\10895', commands = [("base",""),("unicode-math","\\lsimg")], category = Rel, comments = "LESS-THAN ABOVE SIMILAR ABOVE GREATER-THAN"}
  , Record {uchar = '\10896', commands = [("base",""),("unicode-math","\\gsiml")], category = Rel, comments = "GREATER-THAN ABOVE SIMILAR ABOVE LESS-THAN"}
  , Record {uchar = '\10897', commands = [("base",""),("unicode-math","\\lgE")], category = Rel, comments = "LESS-THAN ABOVE GREATER-THAN ABOVE DOUBLE-LINE EQUAL"}
  , Record {uchar = '\10898', commands = [("base",""),("unicode-math","\\glE")], category = Rel, comments = "GREATER-THAN ABOVE LESS-THAN ABOVE DOUBLE-LINE EQUAL"}
  , Record {uchar = '\10899', commands = [("base",""),("unicode-math","\\lesges")], category = Rel, comments = "LESS-THAN ABOVE SLANTED EQUAL ABOVE GREATER-THAN ABOVE SLANTED EQUAL"}
  , Record {uchar = '\10900', commands = [("base",""),("unicode-math","\\gesles")], category = Rel, comments = "GREATER-THAN ABOVE SLANTED EQUAL ABOVE LESS-THAN ABOVE SLANTED EQUAL"}
  ...
  , Record {uchar = '\10903', commands = [("base",""),("unicode-math","\\elsdot")], category = Rel, comments = "SLANTED EQUAL TO OR LESS-THAN WITH DOT INSIDE"}
  , Record {uchar = '\10904', commands = [("base",""),("unicode-math","\\egsdot")], category = Rel, comments = "SLANTED EQUAL TO OR GREATER-THAN WITH DOT INSIDE"}
  , Record {uchar = '\10905', commands = [("base",""),("unicode-math","\\eqqless")], category = Rel, comments = "DOUBLE-LINE EQUAL TO OR LESS-THAN"}
  , Record {uchar = '\10906', commands = [("base",""),("unicode-math","\\eqqgtr")], category = Rel, comments = "DOUBLE-LINE EQUAL TO OR GREATER-THAN"}
  , Record {uchar = '\10907', commands = [("base",""),("unicode-math","\\eqqslantless")], category = Rel, comments = "DOUBLE-LINE SLANTED EQUAL TO OR LESS-THAN"}
  , Record {uchar = '\10908', commands = [("base",""),("unicode-math","\\eqqslantgtr")], category = Rel, comments = "DOUBLE-LINE SLANTED EQUAL TO OR GREATER-THAN"}
  , Record {uchar = '\10909', commands = [("base",""),("unicode-math","\\simless")], category = Rel, comments = "SIMILAR OR LESS-THAN"}
  , Record {uchar = '\10910', commands = [("base",""),("unicode-math","\\simgtr")], category = Rel, comments = "SIMILAR OR GREATER-THAN"}
  , Record {uchar = '\10911', commands = [("base",""),("unicode-math","\\simlE")], category = Rel, comments = "SIMILAR ABOVE LESS-THAN ABOVE EQUALS SIGN"}
  , Record {uchar = '\10912', commands = [("base",""),("unicode-math","\\simgE")], category = Rel, comments = "SIMILAR ABOVE GREATER-THAN ABOVE EQUALS SIGN"}
  ...
  , Record {uchar = '\10915', commands = [("base",""),("unicode-math","\\partialmeetcontraction")], category = Rel, comments = "double less-than with underbar"}
  , Record {uchar = '\10916', commands = [("base",""),("unicode-math","\\glj")], category = Rel, comments = "GREATER-THAN OVERLAPPING LESS-THAN"}
  , Record {uchar = '\10917', commands = [("base",""),("unicode-math","\\gla")], category = Rel, comments = "GREATER-THAN BESIDE LESS-THAN"}
  ...
  , Record {uchar = '\10920', commands = [("base",""),("unicode-math","\\lescc")], category = Rel, comments = "LESS-THAN CLOSED BY CURVE ABOVE SLANTED EQUAL"}
  , Record {uchar = '\10921', commands = [("base",""),("unicode-math","\\gescc")], category = Rel, comments = "GREATER-THAN CLOSED BY CURVE ABOVE SLANTED EQUAL"}
  , Record {uchar = '\10922', commands = [("base",""),("unicode-math","\\smt")], category = Rel, comments = "SMALLER THAN"}
  , Record {uchar = '\10923', commands = [("base",""),("unicode-math","\\lat")], category = Rel, comments = "LARGER THAN"}
  , Record {uchar = '\10924', commands = [("base",""),("unicode-math","\\smte")], category = Rel, comments = "SMALLER THAN OR EQUAL TO"}
  , Record {uchar = '\10925', commands = [("base",""),("unicode-math","\\late")], category = Rel, comments = "LARGER THAN OR EQUAL TO"}
  , Record {uchar = '\10926', commands = [("base",""),("unicode-math","\\bumpeqq")], category = Rel, comments = "EQUALS SIGN WITH BUMPY ABOVE"}
  ...
  , Record {uchar = '\10929', commands = [("base",""),("unicode-math","\\precneq")], category = Rel, comments = "PRECEDES ABOVE SINGLE-LINE NOT EQUAL TO"}
  , Record {uchar = '\10930', commands = [("base",""),("unicode-math","\\succneq")], category = Rel, comments = "SUCCEEDS ABOVE SINGLE-LINE NOT EQUAL TO"}
  ...
  , Record {uchar = '\10933', commands = [("amssymb",""),("unicode-math","\\precneqq")], category = Rel, comments = "PRECEDES ABOVE NOT EQUAL TO"}
  , Record {uchar = '\10934', commands = [("amssymb",""),("unicode-math","\\succneqq")], category = Rel, comments = "SUCCEEDS ABOVE NOT EQUAL TO"}
  ...
  , Record {uchar = '\10941', commands = [("base",""),("unicode-math","\\subsetdot")], category = Rel, comments = "SUBSET WITH DOT"}
  , Record {uchar = '\10942', commands = [("base",""),("unicode-math","\\supsetdot")], category = Rel, comments = "SUPERSET WITH DOT"}
  , Record {uchar = '\10943', commands = [("base",""),("unicode-math","\\subsetplus")], category = Rel, comments = "SUBSET WITH PLUS SIGN BELOW"}
  , Record {uchar = '\10944', commands = [("base",""),("unicode-math","\\supsetplus")], category = Rel, comments = "SUPERSET WITH PLUS SIGN BELOW"}
  , Record {uchar = '\10945', commands = [("base",""),("unicode-math","\\submult")], category = Rel, comments = "SUBSET WITH MULTIPLICATION SIGN BELOW"}
  , Record {uchar = '\10946', commands = [("base",""),("unicode-math","\\supmult")], category = Rel, comments = "SUPERSET WITH MULTIPLICATION SIGN BELOW"}
  , Record {uchar = '\10947', commands = [("base",""),("unicode-math","\\subedot")], category = Rel, comments = "SUBSET OF OR EQUAL TO WITH DOT ABOVE"}
  , Record {uchar = '\10948', commands = [("base",""),("unicode-math","\\supedot")], category = Rel, comments = "SUPERSET OF OR EQUAL TO WITH DOT ABOVE"}
  ...
  , Record {uchar = '\10951', commands = [("base",""),("unicode-math","\\subsim")], category = Rel, comments = "SUBSET OF ABOVE TILDE OPERATOR"}
  , Record {uchar = '\10952', commands = [("base",""),("unicode-math","\\supsim")], category = Rel, comments = "SUPERSET OF ABOVE TILDE OPERATOR"}
  , Record {uchar = '\10953', commands = [("base",""),("unicode-math","\\subsetapprox")], category = Rel, comments = "SUBSET OF ABOVE ALMOST EQUAL TO"}
  , Record {uchar = '\10954', commands = [("base",""),("unicode-math","\\supsetapprox")], category = Rel, comments = "SUPERSET OF ABOVE ALMOST EQUAL TO"}
  ...
  , Record {uchar = '\10957', commands = [("base",""),("unicode-math","\\lsqhook")], category = Rel, comments = "SQUARE LEFT OPEN BOX OPERATOR"}
  , Record {uchar = '\10958', commands = [("base",""),("unicode-math","\\rsqhook")], category = Rel, comments = "SQUARE RIGHT OPEN BOX OPERATOR"}
  , Record {uchar = '\10959', commands = [("base",""),("unicode-math","\\csub")], category = Rel, comments = "CLOSED SUBSET"}
  , Record {uchar = '\10960', commands = [("base",""),("unicode-math","\\csup")], category = Rel, comments = "CLOSED SUPERSET"}
  , Record {uchar = '\10961', commands = [("base",""),("unicode-math","\\csube")], category = Rel, comments = "CLOSED SUBSET OR EQUAL TO"}
  , Record {uchar = '\10962', commands = [("base",""),("unicode-math","\\csupe")], category = Rel, comments = "CLOSED SUPERSET OR EQUAL TO"}
  , Record {uchar = '\10963', commands = [("base",""),("unicode-math","\\subsup")], category = Rel, comments = "SUBSET ABOVE SUPERSET"}
  , Record {uchar = '\10964', commands = [("base",""),("unicode-math","\\supsub")], category = Rel, comments = "SUPERSET ABOVE SUBSET"}
  , Record {uchar = '\10965', commands = [("base",""),("unicode-math","\\subsub")], category = Rel, comments = "SUBSET ABOVE SUBSET"}
  , Record {uchar = '\10966', commands = [("base",""),("unicode-math","\\supsup")], category = Rel, comments = "SUPERSET ABOVE SUPERSET"}
  , Record {uchar = '\10967', commands = [("base",""),("unicode-math","\\suphsub")], category = Rel, comments = "SUPERSET BESIDE SUBSET"}
  , Record {uchar = '\10968', commands = [("base",""),("unicode-math","\\supdsub")], category = Rel, comments = "SUPERSET BESIDE AND JOINED BY DASH WITH SUBSET"}
  , Record {uchar = '\10969', commands = [("base",""),("unicode-math","\\forkv")], category = Rel, comments = "ELEMENT OF OPENING DOWNWARDS"}
  , Record {uchar = '\10970', commands = [("base",""),("unicode-math","\\topfork")], category = Rel, comments = "PITCHFORK WITH TEE TOP"}
  , Record {uchar = '\10971', commands = [("base",""),("unicode-math","\\mlcp")], category = Rel, comments = "TRANSVERSAL INTERSECTION"}
  , Record {uchar = '\10972', commands = [("base",""),("unicode-math","\\forks")], category = Rel, comments = "FORKING"}
  , Record {uchar = '\10973', commands = [("base",""),("unicode-math","\\forksnot")], category = Rel, comments = "NONFORKING"}
  , Record {uchar = '\10974', commands = [("base",""),("unicode-math","\\shortlefttack")], category = Rel, comments = "SHORT LEFT TACK"}
  , Record {uchar = '\10975', commands = [("base",""),("unicode-math","\\shortdowntack")], category = Rel, comments = "SHORT DOWN TACK"}
  , Record {uchar = '\10976', commands = [("base",""),("unicode-math","\\shortuptack")], category = Rel, comments = "SHORT UP TACK"}
  , Record {uchar = '\10977', commands = [("base",""),("unicode-math","\\perps")], category = Ord, comments = "PERPENDICULAR WITH S"}
  , Record {uchar = '\10978', commands = [("base",""),("unicode-math","\\vDdash")], category = Rel, comments = "VERTICAL BAR TRIPLE RIGHT TURNSTILE"}
  , Record {uchar = '\10979', commands = [("base",""),("unicode-math","\\dashV")], category = Rel, comments = "DOUBLE VERTICAL BAR LEFT TURNSTILE"}
  , Record {uchar = '\10980', commands = [("base",""),("unicode-math","\\Dashv")], category = Rel, comments = "VERTICAL BAR DOUBLE LEFT TURNSTILE"}
  , Record {uchar = '\10981', commands = [("base",""),("unicode-math","\\DashV")], category = Rel, comments = "DOUBLE VERTICAL BAR DOUBLE LEFT TURNSTILE"}
  , Record {uchar = '\10982', commands = [("base",""),("unicode-math","\\varVdash")], category = Rel, comments = "LONG DASH FROM LEFT MEMBER OF DOUBLE VERTICAL"}
  , Record {uchar = '\10983', commands = [("base",""),("unicode-math","\\Barv")], category = Rel, comments = "SHORT DOWN TACK WITH OVERBAR"}
  , Record {uchar = '\10984', commands = [("base",""),("unicode-math","\\vBar")], category = Rel, comments = "SHORT UP TACK WITH UNDERBAR"}
  , Record {uchar = '\10985', commands = [("base",""),("unicode-math","\\vBarv")], category = Rel, comments = "SHORT UP TACK ABOVE SHORT DOWN TACK"}
  ...
  , Record {uchar = '\10988', commands = [("base",""),("unicode-math","\\Not")], category = Rel, comments = "DOUBLE STROKE NOT SIGN"}
  , Record {uchar = '\10989', commands = [("base",""),("unicode-math","\\bNot")], category = Rel, comments = "REVERSED DOUBLE STROKE NOT SIGN"}
  , Record {uchar = '\10990', commands = [("base",""),("unicode-math","\\revnmid")], category = Rel, comments = "DOES NOT DIVIDE WITH REVERSED NEGATION SLASH"}
  , Record {uchar = '\10991', commands = [("base",""),("unicode-math","\\cirmid")], category = Rel, comments = "VERTICAL LINE WITH CIRCLE ABOVE"}
  , Record {uchar = '\10992', commands = [("base",""),("unicode-math","\\midcir")], category = Rel, comments = "VERTICAL LINE WITH CIRCLE BELOW"}
  , Record {uchar = '\10993', commands = [("base",""),("unicode-math","\\topcir")], category = Ord, comments = "DOWN TACK WITH CIRCLE BELOW"}
  , Record {uchar = '\10994', commands = [("base",""),("unicode-math","\\nhpar")], category = Rel, comments = "PARALLEL WITH HORIZONTAL STROKE"}
  , Record {uchar = '\10995', commands = [("base",""),("unicode-math","\\parsim")], category = Rel, comments = "PARALLEL WITH TILDE OPERATOR"}
  ...
  , Record {uchar = '\10997', commands = [("base",""),("unicode-math","\\nhVvert")], category = Bin, comments = "TRIPLE VERTICAL BAR WITH HORIZONTAL STROKE"}
  , Record {uchar = '\10998', commands = [("base",""),("unicode-math","\\threedotcolon")], category = Bin, comments = "TRIPLE COLON OPERATOR"}
  , Record {uchar = '\10999', commands = [("base",""),("unicode-math","\\lllnest")], category = Rel, comments = "TRIPLE NESTED LESS-THAN"}
  , Record {uchar = '\11000', commands = [("base",""),("unicode-math","\\gggnest")], category = Rel, comments = "TRIPLE NESTED GREATER-THAN"}
  , Record {uchar = '\11001', commands = [("base",""),("unicode-math","\\leqqslant")], category = Rel, comments = "DOUBLE-LINE SLANTED LESS-THAN OR EQUAL TO"}
  , Record {uchar = '\11002', commands = [("base",""),("unicode-math","\\geqqslant")], category = Rel, comments = "DOUBLE-LINE SLANTED GREATER-THAN OR EQUAL TO"}
  , Record {uchar = '\11003', commands = [("base",""),("unicode-math","\\trslash")], category = Bin, comments = "TRIPLE SOLIDUS BINARY RELATION"}
  ...
  , Record {uchar = '\11007', commands = [("base",""),("unicode-math","\\bigtalloblong")], category = Op, comments = "N-ARY WHITE VERTICAL BAR"}
  , Record {uchar = '\11008', commands = [("base",""),("unicode-math","")], category = Ord, comments = "NORTH EAST WHITE ARROW"}
  , Record {uchar = '\11009', commands = [("base",""),("unicode-math","")], category = Ord, comments = "NORTH WEST WHITE ARROW"}
  , Record {uchar = '\11010', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SOUTH EAST WHITE ARROW"}
  , Record {uchar = '\11011', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SOUTH WEST WHITE ARROW"}
  , Record {uchar = '\11012', commands = [("base",""),("unicode-math","")], category = Ord, comments = "LEFT RIGHT WHITE ARROW"}
  , Record {uchar = '\11013', commands = [("base",""),("unicode-math","")], category = Ord, comments = "LEFTWARDS BLACK ARROW"}
  , Record {uchar = '\11014', commands = [("base",""),("unicode-math","")], category = Ord, comments = "UPWARDS BLACK ARROW"}
  , Record {uchar = '\11015', commands = [("base",""),("unicode-math","")], category = Ord, comments = "DOWNWARDS BLACK ARROW"}
  , Record {uchar = '\11016', commands = [("base",""),("unicode-math","")], category = Ord, comments = "NORTH EAST BLACK ARROW"}
  , Record {uchar = '\11017', commands = [("base",""),("unicode-math","")], category = Ord, comments = "NORTH WEST BLACK ARROW"}
  , Record {uchar = '\11018', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SOUTH EAST BLACK ARROW"}
  , Record {uchar = '\11019', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SOUTH WEST BLACK ARROW"}
  , Record {uchar = '\11020', commands = [("base",""),("unicode-math","")], category = Ord, comments = "LEFT RIGHT BLACK ARROW"}
  , Record {uchar = '\11021', commands = [("base",""),("unicode-math","")], category = Ord, comments = "UP DOWN BLACK ARROW"}
  , Record {uchar = '\11022', commands = [("base",""),("unicode-math","")], category = Ord, comments = "RIGHTWARDS ARROW WITH TIP DOWNWARDS"}
  , Record {uchar = '\11023', commands = [("base",""),("unicode-math","")], category = Ord, comments = "RIGHTWARDS ARROW WITH TIP UPWARDS"}
  , Record {uchar = '\11024', commands = [("base",""),("unicode-math","")], category = Ord, comments = "LEFTWARDS ARROW WITH TIP DOWNWARDS"}
  , Record {uchar = '\11025', commands = [("base",""),("unicode-math","")], category = Ord, comments = "LEFTWARDS ARROW WITH TIP UPWARDS"}
  , Record {uchar = '\11026', commands = [("base",""),("unicode-math","\\squaretopblack")], category = Ord, comments = "SQUARE WITH TOP HALF BLACK"}
  , Record {uchar = '\11027', commands = [("base",""),("unicode-math","\\squarebotblack")], category = Ord, comments = "SQUARE WITH BOTTOM HALF BLACK"}
  , Record {uchar = '\11028', commands = [("base",""),("unicode-math","\\squareurblack")], category = Ord, comments = "SQUARE WITH UPPER RIGHT DIAGONAL HALF BLACK"}
  , Record {uchar = '\11029', commands = [("base",""),("unicode-math","\\squarellblack")], category = Ord, comments = "SQUARE WITH LOWER LEFT DIAGONAL HALF BLACK"}
  , Record {uchar = '\11030', commands = [("base",""),("unicode-math","\\diamondleftblack")], category = Ord, comments = "DIAMOND WITH LEFT HALF BLACK"}
  , Record {uchar = '\11031', commands = [("base",""),("unicode-math","\\diamondrightblack")], category = Ord, comments = "DIAMOND WITH RIGHT HALF BLACK"}
  , Record {uchar = '\11032', commands = [("base",""),("unicode-math","\\diamondtopblack")], category = Ord, comments = "DIAMOND WITH TOP HALF BLACK"}
  , Record {uchar = '\11033', commands = [("base",""),("unicode-math","\\diamondbotblack")], category = Ord, comments = "DIAMOND WITH BOTTOM HALF BLACK"}
  , Record {uchar = '\11034', commands = [("base",""),("unicode-math","\\dottedsquare")], category = Ord, comments = "DOTTED SQUARE"}
  ...
  , Record {uchar = '\11037', commands = [("base",""),("amssymb","\\centerdot"),("unicode-math","\\vysmblksquare")], category = Ord, comments = "t \\Squaredot (marvosym), BLACK VERY SMALL SQUARE"}
  , Record {uchar = '\11038', commands = [("base",""),("unicode-math","\\vysmwhtsquare")], category = Ord, comments = "WHITE VERY SMALL SQUARE"}
  , Record {uchar = '\11039', commands = [("base",""),("unicode-math","\\pentagonblack")], category = Ord, comments = "BLACK PENTAGON"}
  , Record {uchar = '\11040', commands = [("base",""),("unicode-math","\\pentagon")], category = Ord, comments = "WHITE PENTAGON"}
  , Record {uchar = '\11041', commands = [("base",""),("unicode-math","\\varhexagon")], category = Ord, comments = "WHITE HEXAGON"}
  , Record {uchar = '\11042', commands = [("base",""),("unicode-math","\\varhexagonblack")], category = Ord, comments = "BLACK HEXAGON"}
  , Record {uchar = '\11043', commands = [("base",""),("unicode-math","\\hexagonblack")], category = Ord, comments = "HORIZONTAL BLACK HEXAGON"}
  , Record {uchar = '\11044', commands = [("base",""),("unicode-math","\\lgblkcircle")], category = Ord, comments = "BLACK LARGE CIRCLE"}
  , Record {uchar = '\11045', commands = [("base",""),("unicode-math","\\mdblkdiamond")], category = Ord, comments = "BLACK MEDIUM DIAMOND"}
  , Record {uchar = '\11046', commands = [("base",""),("unicode-math","\\mdwhtdiamond")], category = Ord, comments = "WHITE MEDIUM DIAMOND"}
  , Record {uchar = '\11047', commands = [("base",""),("amssymb","\\blacklozenge"),("unicode-math","\\mdblklozenge")], category = Ord, comments = "BLACK MEDIUM LOZENGE"}
  , Record {uchar = '\11048', commands = [("base",""),("amssymb","\\lozenge"),("unicode-math","\\mdwhtlozenge")], category = Ord, comments = "WHITE MEDIUM LOZENGE"}
  , Record {uchar = '\11049', commands = [("base",""),("unicode-math","\\smblkdiamond")], category = Ord, comments = "BLACK SMALL DIAMOND"}
  , Record {uchar = '\11050', commands = [("base",""),("unicode-math","\\smblklozenge")], category = Ord, comments = "BLACK SMALL LOZENGE"}
  , Record {uchar = '\11051', commands = [("base",""),("unicode-math","\\smwhtlozenge")], category = Ord, comments = "WHITE SMALL LOZENGE"}
  , Record {uchar = '\11052', commands = [("base",""),("unicode-math","\\blkhorzoval")], category = Ord, comments = "BLACK HORIZONTAL ELLIPSE"}
  , Record {uchar = '\11053', commands = [("base",""),("unicode-math","\\whthorzoval")], category = Ord, comments = "WHITE HORIZONTAL ELLIPSE"}
  , Record {uchar = '\11054', commands = [("base",""),("unicode-math","\\blkvertoval")], category = Ord, comments = "BLACK VERTICAL ELLIPSE"}
  , Record {uchar = '\11055', commands = [("base",""),("unicode-math","\\whtvertoval")], category = Ord, comments = "WHITE VERTICAL ELLIPSE"}
  , Record {uchar = '\11056', commands = [("base",""),("unicode-math","\\circleonleftarrow")], category = Rel, comments = "LEFT ARROW WITH SMALL CIRCLE"}
  , Record {uchar = '\11057', commands = [("base",""),("unicode-math","\\leftthreearrows")], category = Rel, comments = "THREE LEFTWARDS ARROWS"}
  , Record {uchar = '\11058', commands = [("base",""),("unicode-math","\\leftarrowonoplus")], category = Rel, comments = "LEFT ARROW WITH CIRCLED PLUS"}
  , Record {uchar = '\11059', commands = [("base",""),("unicode-math","\\longleftsquigarrow")], category = Rel, comments = "LONG LEFTWARDS SQUIGGLE ARROW"}
  , Record {uchar = '\11060', commands = [("base",""),("unicode-math","\\nvtwoheadleftarrow")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE"}
  , Record {uchar = '\11061', commands = [("base",""),("unicode-math","\\nVtwoheadleftarrow")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW WITH DOUBLE VERTICAL STROKE"}
  , Record {uchar = '\11062', commands = [("base",""),("unicode-math","\\twoheadmapsfrom")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW FROM BAR"}
  , Record {uchar = '\11063', commands = [("base",""),("unicode-math","\\twoheadleftdbkarrow")], category = Rel, comments = "leftwards two-headed triple-dash arrow"}
  , Record {uchar = '\11064', commands = [("base",""),("unicode-math","\\leftdotarrow")], category = Rel, comments = "LEFTWARDS ARROW WITH DOTTED STEM"}
  , Record {uchar = '\11065', commands = [("base",""),("unicode-math","\\nvleftarrowtail")], category = Rel, comments = "LEFTWARDS ARROW WITH TAIL WITH VERTICAL STROKE"}
  , Record {uchar = '\11066', commands = [("base",""),("unicode-math","\\nVleftarrowtail")], category = Rel, comments = "LEFTWARDS ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE"}
  , Record {uchar = '\11067', commands = [("base",""),("unicode-math","\\twoheadleftarrowtail")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW WITH TAIL"}
  , Record {uchar = '\11068', commands = [("base",""),("unicode-math","\\nvtwoheadleftarrowtail")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW WITH TAIL WITH VERTICAL STROKE"}
  , Record {uchar = '\11069', commands = [("base",""),("unicode-math","\\nVtwoheadleftarrowtail")], category = Rel, comments = "LEFTWARDS TWO-HEADED ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE"}
  , Record {uchar = '\11070', commands = [("base",""),("unicode-math","\\leftarrowx")], category = Rel, comments = "LEFTWARDS ARROW THROUGH X"}
  , Record {uchar = '\11071', commands = [("base",""),("unicode-math","\\leftcurvedarrow")], category = Rel, comments = "WAVE ARROW POINTING DIRECTLY LEFT"}
  , Record {uchar = '\11072', commands = [("base",""),("unicode-math","\\equalleftarrow")], category = Rel, comments = "EQUALS SIGN ABOVE LEFTWARDS ARROW"}
  , Record {uchar = '\11073', commands = [("base",""),("unicode-math","\\bsimilarleftarrow")], category = Rel, comments = "REVERSE TILDE OPERATOR ABOVE LEFTWARDS ARROW"}
  , Record {uchar = '\11074', commands = [("base",""),("unicode-math","\\leftarrowbackapprox")], category = Rel, comments = "LEFTWARDS ARROW ABOVE REVERSE ALMOST EQUAL TO"}
  , Record {uchar = '\11075', commands = [("base",""),("unicode-math","\\rightarrowgtr")], category = Rel, comments = "rightwards arrow through less-than"}
  , Record {uchar = '\11076', commands = [("base",""),("unicode-math","\\rightarrowsupset")], category = Rel, comments = "rightwards arrow through subset"}
  , Record {uchar = '\11077', commands = [("base",""),("unicode-math","\\LLeftarrow")], category = Rel, comments = "LEFTWARDS QUADRUPLE ARROW"}
  , Record {uchar = '\11078', commands = [("base",""),("unicode-math","\\RRightarrow")], category = Rel, comments = "RIGHTWARDS QUADRUPLE ARROW"}
  , Record {uchar = '\11079', commands = [("base",""),("unicode-math","\\bsimilarrightarrow")], category = Rel, comments = "REVERSE TILDE OPERATOR ABOVE RIGHTWARDS ARROW"}
  , Record {uchar = '\11080', commands = [("base",""),("unicode-math","\\rightarrowbackapprox")], category = Rel, comments = "RIGHTWARDS ARROW ABOVE REVERSE ALMOST EQUAL TO"}
  , Record {uchar = '\11081', commands = [("base",""),("unicode-math","\\similarleftarrow")], category = Rel, comments = "TILDE OPERATOR ABOVE LEFTWARDS ARROW"}
  , Record {uchar = '\11082', commands = [("base",""),("unicode-math","\\leftarrowapprox")], category = Rel, comments = "LEFTWARDS ARROW ABOVE ALMOST EQUAL TO"}
  , Record {uchar = '\11083', commands = [("base",""),("unicode-math","\\leftarrowbsimilar")], category = Rel, comments = "LEFTWARDS ARROW ABOVE REVERSE TILDE OPERATOR"}
  , Record {uchar = '\11084', commands = [("base",""),("unicode-math","\\rightarrowbsimilar")], category = Rel, comments = "righttwards arrow above reverse tilde operator"}
  , Record {uchar = '\11088', commands = [("base",""),("unicode-math","\\medwhitestar")], category = Ord, comments = "WHITE MEDIUM STAR"}
  , Record {uchar = '\11089', commands = [("base",""),("unicode-math","\\medblackstar")], category = Ord, comments = "black medium star"}
  , Record {uchar = '\11090', commands = [("base",""),("unicode-math","\\smwhitestar")], category = Ord, comments = "WHITE SMALL STAR"}
  , Record {uchar = '\11091', commands = [("base",""),("unicode-math","\\rightpentagonblack")], category = Ord, comments = "BLACK RIGHT-POINTING PENTAGON"}
  , Record {uchar = '\11092', commands = [("base",""),("unicode-math","\\rightpentagon")], category = Ord, comments = "WHITE RIGHT-POINTING PENTAGON"}
  , Record {uchar = '\12296', commands = [("base",""),("base","\\langle"),("unicode-math","")], category = Open, comments = "LEFT ANGLE BRACKET (deprecated for math use)"}
  , Record {uchar = '\12297', commands = [("base",""),("base","\\rangle"),("unicode-math","")], category = Close, comments = "RIGHT ANGLE BRACKET (deprecated for math use)"}
  , Record {uchar = '\12306', commands = [("base",""),("unicode-math","\\postalmark")], category = Ord, comments = "POSTAL MARK"}
  , Record {uchar = '\12308', commands = [("base",""),("unicode-math","\\lbrbrak")], category = Open, comments = "left broken bracket"}
  , Record {uchar = '\12309', commands = [("base",""),("unicode-math","\\rbrbrak")], category = Close, comments = "right broken bracket"}
  , Record {uchar = '\12312', commands = [("base",""),("unicode-math","\\Lbrbrak")], category = Open, comments = "LEFT WHITE TORTOISE SHELL BRACKET"}
  , Record {uchar = '\12313', commands = [("base",""),("unicode-math","\\Rbrbrak")], category = Close, comments = "RIGHT WHITE TORTOISE SHELL BRACKET"}
  , Record {uchar = '\12314', commands = [("base",""),("stmaryrd","\\llbracket"),("unicode-math","")], category = Open, comments = "LEFT WHITE SQUARE BRACKET (deprecated for math use)"}
  , Record {uchar = '\12315', commands = [("base",""),("stmaryrd","\\rrbracket"),("unicode-math","")], category = Close, comments = "RIGHT WHITE SQUARE BRACKET (deprecated for math use)"}
  , Record {uchar = '\12336', commands = [("base",""),("unicode-math","\\hzigzag")], category = Ord, comments = "zigzag"}
  , Record {uchar = '\12398', commands = [("base",""),("unicode-math","")], category = Alpha, comments = "HIRAGANA LETTER NO"}
  , Record {uchar = '\64297', commands = [("base",""),("unicode-math","")], category = Ord, comments = "HEBREW LETTER ALTERNATIVE PLUS SIGN (doesn't have cross shape)"}
  , Record {uchar = '\65024', commands = [("base",""),("unicode-math","")], category = Accent, comments = "VARIATION SELECTOR-1"}
  , Record {uchar = '\65121', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL ASTERISK"}
  , Record {uchar = '\65122', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL PLUS SIGN"}
  , Record {uchar = '\65123', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL HYPHEN-MINUS"}
  , Record {uchar = '\65124', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL LESS-THAN SIGN"}
  , Record {uchar = '\65125', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL GREATER-THAN SIGN"}
  , Record {uchar = '\65126', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL EQUALS SIGN"}
  , Record {uchar = '\65128', commands = [("base",""),("unicode-math","")], category = Ord, comments = "SMALL REVERSE SOLIDUS"}
  , Record {uchar = '\65291', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH PLUS SIGN"}
  , Record {uchar = '\65308', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH LESS-THAN SIGN"}
  , Record {uchar = '\65309', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH EQUALS SIGN"}
  , Record {uchar = '\65310', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH GREATER-THAN SIGN"}
  , Record {uchar = '\65340', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH REVERSE SOLIDUS"}
  , Record {uchar = '\65342', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH CIRCUMFLEX ACCENT"}
  , Record {uchar = '\65372', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH VERTICAL LINE"}
  , Record {uchar = '\65374', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH TILDE"}
  , Record {uchar = '\65506', commands = [("base",""),("unicode-math","")], category = Ord, comments = "FULLWIDTH NOT SIGN"}
  , Record {uchar = '\65513', commands = [("base",""),("unicode-math","")], category = Ord, comments = "HALFWIDTH LEFTWARDS ARROW"}
  , Record {uchar = '\65514', commands = [("base",""),("unicode-math","")], category = Ord, comments = "HALFWIDTH UPWARDS ARROW"}
  , Record {uchar = '\65515', commands = [("base",""),("unicode-math","")], category = Ord, comments = "HALFWIDTH RIGHTWARDS ARROW"}
  , Record {uchar = '\65516', commands = [("base",""),("unicode-math","")], category = Ord, comments = "HALFWIDTH DOWNWARDS ARROW"}
  ...
  , Record {uchar = '\120016', commands = [("base",""),("unicode-math","\\mbfscrA")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL A"}
  , Record {uchar = '\120017', commands = [("base",""),("unicode-math","\\mbfscrB")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL B"}
  , Record {uchar = '\120018', commands = [("base",""),("unicode-math","\\mbfscrC")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL C"}
  , Record {uchar = '\120019', commands = [("base",""),("unicode-math","\\mbfscrD")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL D"}
  , Record {uchar = '\120020', commands = [("base",""),("unicode-math","\\mbfscrE")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL E"}
  , Record {uchar = '\120021', commands = [("base",""),("unicode-math","\\mbfscrF")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL F"}
  , Record {uchar = '\120022', commands = [("base",""),("unicode-math","\\mbfscrG")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL G"}
  , Record {uchar = '\120023', commands = [("base",""),("unicode-math","\\mbfscrH")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL H"}
  , Record {uchar = '\120024', commands = [("base",""),("unicode-math","\\mbfscrI")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL I"}
  , Record {uchar = '\120025', commands = [("base",""),("unicode-math","\\mbfscrJ")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL J"}
  , Record {uchar = '\120026', commands = [("base",""),("unicode-math","\\mbfscrK")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL K"}
  , Record {uchar = '\120027', commands = [("base",""),("unicode-math","\\mbfscrL")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL L"}
  , Record {uchar = '\120028', commands = [("base",""),("unicode-math","\\mbfscrM")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL M"}
  , Record {uchar = '\120029', commands = [("base",""),("unicode-math","\\mbfscrN")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL N"}
  , Record {uchar = '\120030', commands = [("base",""),("unicode-math","\\mbfscrO")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL O"}
  , Record {uchar = '\120031', commands = [("base",""),("unicode-math","\\mbfscrP")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL P"}
  , Record {uchar = '\120032', commands = [("base",""),("unicode-math","\\mbfscrQ")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL Q"}
  , Record {uchar = '\120033', commands = [("base",""),("unicode-math","\\mbfscrR")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL R"}
  , Record {uchar = '\120034', commands = [("base",""),("unicode-math","\\mbfscrS")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL S"}
  , Record {uchar = '\120035', commands = [("base",""),("unicode-math","\\mbfscrT")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL T"}
  , Record {uchar = '\120036', commands = [("base",""),("unicode-math","\\mbfscrU")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL U"}
  , Record {uchar = '\120037', commands = [("base",""),("unicode-math","\\mbfscrV")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL V"}
  , Record {uchar = '\120038', commands = [("base",""),("unicode-math","\\mbfscrW")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL W"}
  , Record {uchar = '\120039', commands = [("base",""),("unicode-math","\\mbfscrX")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL X"}
  , Record {uchar = '\120040', commands = [("base",""),("unicode-math","\\mbfscrY")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL Y"}
  , Record {uchar = '\120041', commands = [("base",""),("unicode-math","\\mbfscrZ")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT CAPITAL Z"}
  , Record {uchar = '\120042', commands = [("base",""),("unicode-math","\\mbfscra")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL A"}
  , Record {uchar = '\120043', commands = [("base",""),("unicode-math","\\mbfscrb")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL B"}
  , Record {uchar = '\120044', commands = [("base",""),("unicode-math","\\mbfscrc")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL C"}
  , Record {uchar = '\120045', commands = [("base",""),("unicode-math","\\mbfscrd")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL D"}
  , Record {uchar = '\120046', commands = [("base",""),("unicode-math","\\mbfscre")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL E"}
  , Record {uchar = '\120047', commands = [("base",""),("unicode-math","\\mbfscrf")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL F"}
  , Record {uchar = '\120048', commands = [("base",""),("unicode-math","\\mbfscrg")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL G"}
  , Record {uchar = '\120049', commands = [("base",""),("unicode-math","\\mbfscrh")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL H"}
  , Record {uchar = '\120050', commands = [("base",""),("unicode-math","\\mbfscri")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL I"}
  , Record {uchar = '\120051', commands = [("base",""),("unicode-math","\\mbfscrj")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL J"}
  , Record {uchar = '\120052', commands = [("base",""),("unicode-math","\\mbfscrk")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL K"}
  , Record {uchar = '\120053', commands = [("base",""),("unicode-math","\\mbfscrl")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL L"}
  , Record {uchar = '\120054', commands = [("base",""),("unicode-math","\\mbfscrm")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL M"}
  , Record {uchar = '\120055', commands = [("base",""),("unicode-math","\\mbfscrn")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL N"}
  , Record {uchar = '\120056', commands = [("base",""),("unicode-math","\\mbfscro")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL O"}
  , Record {uchar = '\120057', commands = [("base",""),("unicode-math","\\mbfscrp")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL P"}
  , Record {uchar = '\120058', commands = [("base",""),("unicode-math","\\mbfscrq")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL Q"}
  , Record {uchar = '\120059', commands = [("base",""),("unicode-math","\\mbfscrr")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL R"}
  , Record {uchar = '\120060', commands = [("base",""),("unicode-math","\\mbfscrs")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL S"}
  , Record {uchar = '\120061', commands = [("base",""),("unicode-math","\\mbfscrt")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL T"}
  , Record {uchar = '\120062', commands = [("base",""),("unicode-math","\\mbfscru")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL U"}
  , Record {uchar = '\120063', commands = [("base",""),("unicode-math","\\mbfscrv")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL V"}
  , Record {uchar = '\120064', commands = [("base",""),("unicode-math","\\mbfscrw")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL W"}
  , Record {uchar = '\120065', commands = [("base",""),("unicode-math","\\mbfscrx")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL X"}
  , Record {uchar = '\120066', commands = [("base",""),("unicode-math","\\mbfscry")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL Y"}
  , Record {uchar = '\120067', commands = [("base",""),("unicode-math","\\mbfscrz")], category = Alpha, comments = "MATHEMATICAL BOLD SCRIPT SMALL Z"}
  ...
  , Record {uchar = '\120172', commands = [("base",""),("unicode-math","\\mbffrakA")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL A"}
  , Record {uchar = '\120173', commands = [("base",""),("unicode-math","\\mbffrakB")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL B"}
  , Record {uchar = '\120174', commands = [("base",""),("unicode-math","\\mbffrakC")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL C"}
  , Record {uchar = '\120175', commands = [("base",""),("unicode-math","\\mbffrakD")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL D"}
  , Record {uchar = '\120176', commands = [("base",""),("unicode-math","\\mbffrakE")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL E"}
  , Record {uchar = '\120177', commands = [("base",""),("unicode-math","\\mbffrakF")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL F"}
  , Record {uchar = '\120178', commands = [("base",""),("unicode-math","\\mbffrakG")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL G"}
  , Record {uchar = '\120179', commands = [("base",""),("unicode-math","\\mbffrakH")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL H"}
  , Record {uchar = '\120180', commands = [("base",""),("unicode-math","\\mbffrakI")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL I"}
  , Record {uchar = '\120181', commands = [("base",""),("unicode-math","\\mbffrakJ")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL J"}
  , Record {uchar = '\120182', commands = [("base",""),("unicode-math","\\mbffrakK")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL K"}
  , Record {uchar = '\120183', commands = [("base",""),("unicode-math","\\mbffrakL")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL L"}
  , Record {uchar = '\120184', commands = [("base",""),("unicode-math","\\mbffrakM")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL M"}
  , Record {uchar = '\120185', commands = [("base",""),("unicode-math","\\mbffrakN")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL N"}
  , Record {uchar = '\120186', commands = [("base",""),("unicode-math","\\mbffrakO")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL O"}
  , Record {uchar = '\120187', commands = [("base",""),("unicode-math","\\mbffrakP")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL P"}
  , Record {uchar = '\120188', commands = [("base",""),("unicode-math","\\mbffrakQ")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL Q"}
  , Record {uchar = '\120189', commands = [("base",""),("unicode-math","\\mbffrakR")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL R"}
  , Record {uchar = '\120190', commands = [("base",""),("unicode-math","\\mbffrakS")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL S"}
  , Record {uchar = '\120191', commands = [("base",""),("unicode-math","\\mbffrakT")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL T"}
  , Record {uchar = '\120192', commands = [("base",""),("unicode-math","\\mbffrakU")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL U"}
  , Record {uchar = '\120193', commands = [("base",""),("unicode-math","\\mbffrakV")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL V"}
  , Record {uchar = '\120194', commands = [("base",""),("unicode-math","\\mbffrakW")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL W"}
  , Record {uchar = '\120195', commands = [("base",""),("unicode-math","\\mbffrakX")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL X"}
  , Record {uchar = '\120196', commands = [("base",""),("unicode-math","\\mbffrakY")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL Y"}
  , Record {uchar = '\120197', commands = [("base",""),("unicode-math","\\mbffrakZ")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR CAPITAL Z"}
  , Record {uchar = '\120198', commands = [("base",""),("unicode-math","\\mbffraka")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL A"}
  , Record {uchar = '\120199', commands = [("base",""),("unicode-math","\\mbffrakb")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL B"}
  , Record {uchar = '\120200', commands = [("base",""),("unicode-math","\\mbffrakc")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL C"}
  , Record {uchar = '\120201', commands = [("base",""),("unicode-math","\\mbffrakd")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL D"}
  , Record {uchar = '\120202', commands = [("base",""),("unicode-math","\\mbffrake")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL E"}
  , Record {uchar = '\120203', commands = [("base",""),("unicode-math","\\mbffrakf")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL F"}
  , Record {uchar = '\120204', commands = [("base",""),("unicode-math","\\mbffrakg")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL G"}
  , Record {uchar = '\120205', commands = [("base",""),("unicode-math","\\mbffrakh")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL H"}
  , Record {uchar = '\120206', commands = [("base",""),("unicode-math","\\mbffraki")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL I"}
  , Record {uchar = '\120207', commands = [("base",""),("unicode-math","\\mbffrakj")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL J"}
  , Record {uchar = '\120208', commands = [("base",""),("unicode-math","\\mbffrakk")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL K"}
  , Record {uchar = '\120209', commands = [("base",""),("unicode-math","\\mbffrakl")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL L"}
  , Record {uchar = '\120210', commands = [("base",""),("unicode-math","\\mbffrakm")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL M"}
  , Record {uchar = '\120211', commands = [("base",""),("unicode-math","\\mbffrakn")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL N"}
  , Record {uchar = '\120212', commands = [("base",""),("unicode-math","\\mbffrako")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL O"}
  , Record {uchar = '\120213', commands = [("base",""),("unicode-math","\\mbffrakp")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL P"}
  , Record {uchar = '\120214', commands = [("base",""),("unicode-math","\\mbffrakq")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL Q"}
  , Record {uchar = '\120215', commands = [("base",""),("unicode-math","\\mbffrakr")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL R"}
  , Record {uchar = '\120216', commands = [("base",""),("unicode-math","\\mbffraks")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL S"}
  , Record {uchar = '\120217', commands = [("base",""),("unicode-math","\\mbffrakt")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL T"}
  , Record {uchar = '\120218', commands = [("base",""),("unicode-math","\\mbffraku")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL U"}
  , Record {uchar = '\120219', commands = [("base",""),("unicode-math","\\mbffrakv")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL V"}
  , Record {uchar = '\120220', commands = [("base",""),("unicode-math","\\mbffrakw")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL W"}
  , Record {uchar = '\120221', commands = [("base",""),("unicode-math","\\mbffrakx")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL X"}
  , Record {uchar = '\120222', commands = [("base",""),("unicode-math","\\mbffraky")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL Y"}
  , Record {uchar = '\120223', commands = [("base",""),("unicode-math","\\mbffrakz")], category = Alpha, comments = "MATHEMATICAL BOLD FRAKTUR SMALL Z"}
  ...
  , Record {uchar = '\120488', commands = [("base",""),("unicode-math","\\mbfAlpha")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL ALPHA"}
  , Record {uchar = '\120489', commands = [("base",""),("unicode-math","\\mbfBeta")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL BETA"}
  ...
  , Record {uchar = '\120492', commands = [("base",""),("unicode-math","\\mbfEpsilon")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL EPSILON"}
  , Record {uchar = '\120493', commands = [("base",""),("unicode-math","\\mbfZeta")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL ZETA"}
  , Record {uchar = '\120494', commands = [("base",""),("unicode-math","\\mbfEta")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL ETA"}
  ...
  , Record {uchar = '\120496', commands = [("base",""),("unicode-math","\\mbfIota")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL IOTA"}
  , Record {uchar = '\120497', commands = [("base",""),("unicode-math","\\mbfKappa")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL KAPPA"}
  ...
  , Record {uchar = '\120499', commands = [("base",""),("unicode-math","\\mbfMu")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL MU"}
  , Record {uchar = '\120500', commands = [("base",""),("unicode-math","\\mbfNu")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL NU"}
  , Record {uchar = '\120501', commands = [("base","\\mathbf{\\Xi}"),("unicode-math","\\mbfXi")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL XI"}
  , Record {uchar = '\120502', commands = [("base",""),("unicode-math","\\mbfOmicron")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL OMICRON"}
  , Record {uchar = '\120503', commands = [("base","\\mathbf{\\Pi}"),("unicode-math","\\mbfPi")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL PI"}
  , Record {uchar = '\120504', commands = [("base",""),("unicode-math","\\mbfRho")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL RHO"}
  , Record {uchar = '\120505', commands = [("base",""),("unicode-math","\\mbfvarTheta")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL THETA SYMBOL"}
  ...
  , Record {uchar = '\120507', commands = [("base",""),("unicode-math","\\mbfTau")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL TAU"}
  ...
  , Record {uchar = '\120510', commands = [("base",""),("unicode-math","\\mbfChi")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL CHI"}
  ...
  , Record {uchar = '\120513', commands = [("base",""),("unicode-math","\\mbfnabla")], category = Ord, comments = "MATHEMATICAL BOLD NABLA"}
  ...
  , Record {uchar = '\120528', commands = [("base",""),("unicode-math","\\mbfomicron")], category = Alpha, comments = "MATHEMATICAL BOLD SMALL OMICRON"}
  ...
  , Record {uchar = '\120539', commands = [("base",""),("unicode-math","\\mbfpartial")], category = Ord, comments = "MATHEMATICAL BOLD PARTIAL DIFFERENTIAL"}
  ...
  , Record {uchar = '\120542', commands = [("base",""),("unicode-math","\\mbfvarkappa")], category = Alpha, comments = "MATHEMATICAL BOLD KAPPA SYMBOL"}
  ...
  , Record {uchar = '\120546', commands = [("base",""),("unicode-math","\\mitAlpha")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL ALPHA"}
  , Record {uchar = '\120547', commands = [("base",""),("unicode-math","\\mitBeta")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL BETA"}
  ...
  , Record {uchar = '\120550', commands = [("base",""),("unicode-math","\\mitEpsilon")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL EPSILON"}
  , Record {uchar = '\120551', commands = [("base",""),("unicode-math","\\mitZeta")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL ZETA"}
  , Record {uchar = '\120552', commands = [("base",""),("unicode-math","\\mitEta")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL ETA"}
  ...
  , Record {uchar = '\120554', commands = [("base",""),("unicode-math","\\mitIota")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL IOTA"}
  , Record {uchar = '\120555', commands = [("base",""),("unicode-math","\\mitKappa")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL KAPPA"}
  ...
  , Record {uchar = '\120557', commands = [("base",""),("unicode-math","\\mitMu")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL MU"}
  , Record {uchar = '\120558', commands = [("base",""),("unicode-math","\\mitNu")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL NU"}
  ...
  , Record {uchar = '\120560', commands = [("base",""),("unicode-math","\\mitOmicron")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL OMICRON"}
  ...
  , Record {uchar = '\120562', commands = [("base",""),("unicode-math","\\mitRho")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL RHO"}
  , Record {uchar = '\120563', commands = [("base",""),("unicode-math","\\mitvarTheta")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL THETA SYMBOL"}
  ...
  , Record {uchar = '\120565', commands = [("base",""),("unicode-math","\\mitTau")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL TAU"}
  ...
  , Record {uchar = '\120568', commands = [("base",""),("unicode-math","\\mitChi")], category = Alpha, comments = "MATHEMATICAL ITALIC CAPITAL CHI"}
  ...
  , Record {uchar = '\120571', commands = [("base",""),("unicode-math","\\mitnabla")], category = Ord, comments = "MATHEMATICAL ITALIC NABLA"}
  ...
  , Record {uchar = '\120586', commands = [("base",""),("unicode-math","\\mitomicron")], category = Alpha, comments = "MATHEMATICAL ITALIC SMALL OMICRON"}
  ...
  , Record {uchar = '\120604', commands = [("base",""),("unicode-math","\\mbfitAlpha")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL ALPHA"}
  , Record {uchar = '\120605', commands = [("base",""),("unicode-math","\\mbfitBeta")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL BETA"}
  ...
  , Record {uchar = '\120608', commands = [("base",""),("unicode-math","\\mbfitEpsilon")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL EPSILON"}
  , Record {uchar = '\120609', commands = [("base",""),("unicode-math","\\mbfitZeta")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL ZETA"}
  , Record {uchar = '\120610', commands = [("base",""),("unicode-math","\\mbfitEta")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL ETA"}
  ...
  , Record {uchar = '\120612', commands = [("base",""),("unicode-math","\\mbfitIota")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL IOTA"}
  , Record {uchar = '\120613', commands = [("base",""),("unicode-math","\\mbfitKappa")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL KAPPA"}
  ...
  , Record {uchar = '\120615', commands = [("base",""),("unicode-math","\\mbfitMu")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL MU"}
  , Record {uchar = '\120616', commands = [("base",""),("unicode-math","\\mbfitNu")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL NU"}
  ...
  , Record {uchar = '\120618', commands = [("base",""),("unicode-math","\\mbfitOmicron")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL OMICRON"}
  ...
  , Record {uchar = '\120620', commands = [("base",""),("unicode-math","\\mbfitRho")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL RHO"}
  , Record {uchar = '\120621', commands = [("base",""),("unicode-math","\\mbfitvarTheta")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL THETA SYMBOL"}
  ...
  , Record {uchar = '\120623', commands = [("base",""),("unicode-math","\\mbfitTau")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL TAU"}
  ...
  , Record {uchar = '\120626', commands = [("base",""),("unicode-math","\\mbfitChi")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC CAPITAL CHI"}
  ...
  , Record {uchar = '\120629', commands = [("base",""),("unicode-math","\\mbfitnabla")], category = Ord, comments = "MATHEMATICAL BOLD ITALIC NABLA"}
  ...
  , Record {uchar = '\120644', commands = [("base",""),("unicode-math","\\mbfitomicron")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC SMALL OMICRON"}
  ...
  , Record {uchar = '\120655', commands = [("base",""),("unicode-math","\\mbfitpartial")], category = Ord, comments = "MATHEMATICAL BOLD ITALIC PARTIAL DIFFERENTIAL"}
  ...
  , Record {uchar = '\120658', commands = [("base",""),("unicode-math","\\mbfitvarkappa")], category = Alpha, comments = "MATHEMATICAL BOLD ITALIC KAPPA SYMBOL"}
  ...
  , Record {uchar = '\120662', commands = [("base",""),("unicode-math","\\mbfsansAlpha")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL ALPHA"}
  , Record {uchar = '\120663', commands = [("base",""),("unicode-math","\\mbfsansBeta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL BETA"}
  ...
  , Record {uchar = '\120666', commands = [("base",""),("unicode-math","\\mbfsansEpsilon")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL EPSILON"}
  , Record {uchar = '\120667', commands = [("base",""),("unicode-math","\\mbfsansZeta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL ZETA"}
  , Record {uchar = '\120668', commands = [("base",""),("unicode-math","\\mbfsansEta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL ETA"}
  ...
  , Record {uchar = '\120670', commands = [("base",""),("unicode-math","\\mbfsansIota")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL IOTA"}
  , Record {uchar = '\120671', commands = [("base",""),("unicode-math","\\mbfsansKappa")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL KAPPA"}
  ...
  , Record {uchar = '\120673', commands = [("base",""),("unicode-math","\\mbfsansMu")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL MU"}
  , Record {uchar = '\120674', commands = [("base",""),("unicode-math","\\mbfsansNu")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL NU"}
  ...
  , Record {uchar = '\120676', commands = [("base",""),("unicode-math","\\mbfsansOmicron")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL OMICRON"}
  ...
  , Record {uchar = '\120678', commands = [("base",""),("unicode-math","\\mbfsansRho")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL RHO"}
  , Record {uchar = '\120679', commands = [("base",""),("unicode-math","\\mbfsansvarTheta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL THETA SYMBOL"}
  ...
  , Record {uchar = '\120681', commands = [("base",""),("unicode-math","\\mbfsansTau")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL TAU"}
  ...
  , Record {uchar = '\120684', commands = [("base",""),("unicode-math","\\mbfsansChi")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD CAPITAL CHI"}
  ...
  , Record {uchar = '\120687', commands = [("base",""),("unicode-math","\\mbfsansnabla")], category = Ord, comments = "MATHEMATICAL SANS-SERIF BOLD NABLA"}
  ...
  , Record {uchar = '\120702', commands = [("base",""),("unicode-math","\\mbfsansomicron")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD SMALL OMICRON"}
  ...
  , Record {uchar = '\120713', commands = [("base",""),("unicode-math","\\mbfsanspartial")], category = Ord, comments = "MATHEMATICAL SANS-SERIF BOLD PARTIAL DIFFERENTIAL"}
  ...
  , Record {uchar = '\120716', commands = [("base",""),("unicode-math","\\mbfsansvarkappa")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD KAPPA SYMBOL"}
  ...
  , Record {uchar = '\120720', commands = [("base",""),("unicode-math","\\mbfitsansAlpha")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ALPHA"}
  , Record {uchar = '\120721', commands = [("base",""),("unicode-math","\\mbfitsansBeta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL BETA"}
  ...
  , Record {uchar = '\120724', commands = [("base",""),("unicode-math","\\mbfitsansEpsilon")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL EPSILON"}
  , Record {uchar = '\120725', commands = [("base",""),("unicode-math","\\mbfitsansZeta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ZETA"}
  , Record {uchar = '\120726', commands = [("base",""),("unicode-math","\\mbfitsansEta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ETA"}
  ...
  , Record {uchar = '\120728', commands = [("base",""),("unicode-math","\\mbfitsansIota")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL IOTA"}
  , Record {uchar = '\120729', commands = [("base",""),("unicode-math","\\mbfitsansKappa")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL KAPPA"}
  ...
  , Record {uchar = '\120731', commands = [("base",""),("unicode-math","\\mbfitsansMu")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL MU"}
  , Record {uchar = '\120732', commands = [("base",""),("unicode-math","\\mbfitsansNu")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL NU"}
  ...
  , Record {uchar = '\120734', commands = [("base",""),("unicode-math","\\mbfitsansOmicron")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL OMICRON"}
  ...
  , Record {uchar = '\120736', commands = [("base",""),("unicode-math","\\mbfitsansRho")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL RHO"}
  , Record {uchar = '\120737', commands = [("base",""),("unicode-math","\\mbfitsansvarTheta")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL THETA SYMBOL"}
  ...
  , Record {uchar = '\120739', commands = [("base",""),("unicode-math","\\mbfitsansTau")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL TAU"}
  ...
  , Record {uchar = '\120742', commands = [("base",""),("unicode-math","\\mbfitsansChi")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL CHI"}
  ...
  , Record {uchar = '\120745', commands = [("base",""),("unicode-math","\\mbfitsansnabla")], category = Ord, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC NABLA"}
  ...
  , Record {uchar = '\120760', commands = [("base",""),("unicode-math","\\mbfitsansomicron")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL OMICRON"}
  ...
  , Record {uchar = '\120771', commands = [("base",""),("unicode-math","\\mbfitsanspartial")], category = Ord, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC PARTIAL DIFFERENTIAL"}
  ...
  , Record {uchar = '\120774', commands = [("base",""),("unicode-math","\\mbfitsansvarkappa")], category = Alpha, comments = "MATHEMATICAL SANS-SERIF BOLD ITALIC KAPPA SYMBOL"}
  ...
  , Record {uchar = '\120778', commands = [("base",""),("unicode-math","\\mbfDigamma")], category = Alpha, comments = "MATHEMATICAL BOLD CAPITAL DIGAMMA"}
  , Record {uchar = '\120779', commands = [("base",""),("unicode-math","\\mbfdigamma")], category = Alpha, comments = "MATHEMATICAL BOLD SMALL DIGAMMA"}
  , Record {uchar = '\120782', commands = [("base","\\mathbf{0}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 0"}
  , Record {uchar = '\120783', commands = [("base","\\mathbf{1}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 1"}
  , Record {uchar = '\120784', commands = [("base","\\mathbf{2}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 2"}
  , Record {uchar = '\120785', commands = [("base","\\mathbf{3}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 3"}
  , Record {uchar = '\120786', commands = [("base","\\mathbf{4}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 4"}
  , Record {uchar = '\120787', commands = [("base","\\mathbf{5}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 5"}
  , Record {uchar = '\120788', commands = [("base","\\mathbf{6}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 6"}
  , Record {uchar = '\120789', commands = [("base","\\mathbf{7}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 7"}
  , Record {uchar = '\120790', commands = [("base","\\mathbf{8}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 8"}
  , Record {uchar = '\120791', commands = [("base","\\mathbf{9}"),("unicode-math","")], category = Ord, comments = "mathematical bold digit 9"}
